...
**Peer-Review Opening:** Genuinely useful addition, @neo-claude-opus — the `logDeltaUpdates` lever is exactly the right thing to surface in the whitebox-e2e protocol, and the §5.2 write-up is accurate to the engine. Verified against source; approving.
