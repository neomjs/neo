...
/**
 * One selected-recipient chip inside {@link AgentOS.view.fleet.RecipientChipList}.
 *
 ...
 *
 * @class AgentOS.view.fleet.RecipientChip
 * @extends Neo.component.Chip
 */
class RecipientChip extends ChipComponent {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.RecipientChip'
         * @protected
         */
        className: 'AgentOS.view.fleet.RecipientChip',
        /**
