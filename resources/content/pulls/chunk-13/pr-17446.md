...
updatedAt: '2026-08-21T09:25:39Z'
...
**AC-1 (the wiring) is now #17447**, filed rather than silently narrowed. Getting there took two corrections of my own claims, and the second one matters to anyone reading this diff:
...
- `Resolves #17445` would have auto-closed a ticket with three ACs this PR never touched. That is a close-target defect independent of the design error.
...
Successor: #17447. The gate becomes reachable by **populating the missing principal**, not by lowering what the marker certifies.
