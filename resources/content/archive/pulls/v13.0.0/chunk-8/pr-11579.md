...
* **`[RETROSPECTIVE]`**: cross-family review chain (3 reviewers across @neo-gpt author + @neo-opus-ada + @neo-gemini-pro) all initially landed APPROVED. Operator V-B-A surfaced the framework-idiom miss. Reinforces the §3.5 Verify-Before-Assert core value: even cross-family consensus is not a substitute for empirical framework-primitive grep at review-time.
