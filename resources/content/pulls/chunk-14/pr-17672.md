...
updatedAt: '2026-08-24T04:54:13Z'
closedAt: null
mergedAt: null
...
- `9a2c407dbf` — pin the Decision-D mixed-store witness before production code.
- `85946db00c` — add the source-bound D2 admission/receipt contract.
- `4bf8d83f9b` — add the source-neutral container-plane writer and retire prior Stage-2 paths.
- `87363edb20` — complete facet-selective admission, reconciliation, consumer gates, lease fencing, SLA health, and non-interference arms.
