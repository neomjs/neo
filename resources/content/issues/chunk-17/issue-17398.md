...
updatedAt: '2026-08-20T11:10:06Z'
...
**Expected to split.** Two acquisition paths plus a three-part exit contract is more than one PR can `Resolves`, so this should decompose into leaves rather than be forced into one body.
