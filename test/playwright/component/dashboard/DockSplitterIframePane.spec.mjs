...
/**
 * A splitter drag whose path crosses an iframe. The enforcement AC this pins lives in #17883
 * [not-ticket-ref: the authority for the behaviour asserted below]: the gesture must complete and
 * terminate when the pointer passes over a nested browsing context.
 *
