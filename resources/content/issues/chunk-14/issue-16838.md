...
updatedAt: '2026-08-11T14:51:36Z'
...
**PR #16811 is CLOSED, `merged=never`.** Its 538-line static topology guard never reached `dev`. Neither named mutation is reproducible today because `findModuleConst()` and the file-wide `ClassBody` census do not exist:
