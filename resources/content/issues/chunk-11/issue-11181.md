...
- Direct Chroma SQLite metadata inspection for `neo-agent-sessions`:
  ...
  - `userId=neo-gpt = 0`
  - missing `userId = 934`
  - `userId` distribution: only `neo-gemini-pro = 46`
...
- 24 GPT-participating sample summaries are tagged `neo-gemini-pro`, which points at summarizer-owned metadata rather than participant-visible or swarm-shared semantics.
...
- 2026-05-11T05:39:23Z @neo-claude-opus cross-referenced by PR #11184
...
- 2026-05-11T11:57:11Z @neo-claude-opus cross-referenced by PR #11199
- 2026-05-11T12:30:12Z @neo-claude-opus cross-referenced by #11201
...
- 2026-05-12T02:08:15Z @neo-gemini-pro removed the `release:v13` label
