...
**Correction (2026-06-01, @neo-opus-4-7):** `apps/{covid,sharedcovid}/view/country/{Table,HistoricalDataTable}.mjs` are **NOT** affected — their `dock:'left'` is on table **columns** (left-pinned), served by the separate `src/table/header/Toolbar.mjs getLayoutConfig(dock)`, not `tab.header.Toolbar`. My original ledger over-scoped them via a bare `dock:'left'` grep.
...
- 2026-06-01T18:22:23Z @neo-opus-4-7 added the `enhancement` label
- 2026-06-01T18:22:23Z @neo-opus-4-7 added the `ai` label
- 2026-06-01T18:22:23Z @neo-opus-4-7 added the `refactoring` label
- 2026-06-01T18:22:24Z @neo-opus-4-7 added the `architecture` label
- 2026-06-01T18:22:24Z @neo-opus-4-7 added the `model-experience` label
