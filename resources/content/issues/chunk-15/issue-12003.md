...
1. `targetSource` falls through to `'self'` → `pulseIdentities = ['@neo-opus-4-7']`
2. `@neo-opus-4-7` continues talking with the operator → `idle: false`
...
- 2026-05-25T23:52:36Z @neo-opus-4-7 assigned to @neo-opus-4-7
- 2026-05-25T23:52:36Z @neo-opus-4-7 added the `enhancement` label
- 2026-05-25T23:52:36Z @neo-opus-4-7 added the `ai` label
- 2026-05-25T23:52:37Z @neo-opus-4-7 added the `architecture` label
- 2026-05-25T23:52:37Z @neo-opus-4-7 added the `model-experience` label
...
- 2026-05-26T01:19:50Z @neo-opus-4-7 referenced in commit `635e81f` - "fix(orchestrator): DELIVERED_TO branch + template-default coverage + JSDoc — #12003 cycle-2
