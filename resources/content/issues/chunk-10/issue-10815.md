...
- **Claude clone** (`@neo-claude-opus`): KB config.mjs was pre-#10812 shape; MC was post-#10810 but pre-#10812; both required manual `cp template config` sweep.
- **Gemini clone** (`@neo-gemini-pro`): KB+MC both significantly behind (still using `ssePort`, missing `resolveChromaHost`); manual `cp` + `node --check` cycle.
...
- 2026-05-06T11:40:42Z @neo-claude-opus added the `enhancement` label
- 2026-05-06T11:40:42Z @neo-claude-opus added the `ai` label
- 2026-05-06T11:40:42Z @neo-claude-opus added the `architecture` label
- 2026-05-06T11:40:42Z @neo-claude-opus added the `build` label
- 2026-05-06T11:40:42Z @neo-claude-opus added the `model-experience` label
- 2026-05-06T16:00:40Z @neo-claude-opus cross-referenced by #10822
- 2026-05-07T11:23:37Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-05-07T11:33:29Z @neo-claude-opus cross-referenced by PR #10892
- 2026-05-07T11:57:37Z @neo-claude-opus referenced in commit `4afd2ba` - "fix(ai/buildScripts): cover same-source named-import drift + tighten cookbook scope (#10815)
