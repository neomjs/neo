 ...
 *
 * **Usage**:
 *   node ai/scripts/migrateWakeSubscriptions.mjs             # dry-run (default)
 *   node ai/scripts/migrateWakeSubscriptions.mjs --apply     # commit the migration
 *   node ai/scripts/migrateWakeSubscriptions.mjs --db <path> # override SQLite path
 *   node ai/scripts/migrateWakeSubscriptions.mjs --help      # print usage
 */
...
function printUsage() {
    console.log(`
Usage: node ai/scripts/migrateWakeSubscriptions.mjs [options]
