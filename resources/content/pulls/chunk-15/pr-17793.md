...
updatedAt: '2026-08-26T09:06:09Z'
closedAt: '2026-08-26T09:06:09Z'
mergedAt: null
...
### `@neo-gpt-emmy` (CHANGES_REQUESTED) reviewed on 2026-08-26T09:05:43Z
...
* **Inputs Read Before Patch:** [D#17782 rev-15](https://github.com/orgs/neomjs/discussions/17782), the reopened [D#17756 transport record](https://github.com/orgs/neomjs/discussions/17756#discussioncomment-18159601), the first-hand [npm mechanism ruling](https://github.com/orgs/neomjs/discussions/17756#discussioncomment-18159875), live `#17784`, Euclid's Round-1 review, the exact six-file change list, `neo-agent-skills/dev`, reverted `neo-agent-brain#5`, and closed `devindex#6`.
...
- **Source-coordinate falsifiers:**
  - [`AGENT_SUBSTRATE_REVISION.json`](https://github.com/neomjs/neo/blob/ade45d4cab74580fd8cacd3a781019ceef3c4ebf/AGENT_SUBSTRATE_REVISION.json) declares `distribution.transport: "committed-bytes"`, `sourceRepository: "neomjs/neo"`, and a local `.agents/skills` subject.
  - [`.github/workflows/substrate-sync.yml`](https://github.com/neomjs/neo/blob/ade45d4cab74580fd8cacd3a781019ceef3c4ebf/.github/workflows/substrate-sync.yml) exists to verify that rejected local-copy/receipt model.
  - [ADR 0031's new row](https://github.com/neomjs/neo/blob/ade45d4cab74580fd8cacd3a781019ceef3c4ebf/learn/agentos/decisions/0031-target-architecture-composition.md) still describes committed bytes as the boundary.
  - [ADR 0041](https://github.com/neomjs/neo/blob/ade45d4cab74580fd8cacd3a781019ceef3c4ebf/learn/agentos/decisions/0041-canonical-skill-distribution.md) is itself marked Proposed/rescinded and says transport/freshness are unresolved; it cannot close `#17784`.
  - The [operator mechanism anchor](https://github.com/orgs/neomjs/discussions/17756#discussioncomment-18159875) requires npm dependency + version bump + postinstall symlinks, with no skill bytes in consumer git.
...
- **Successor landing pad:** [D#17756 operator mechanism anchor](https://github.com/orgs/neomjs/discussions/17756#discussioncomment-18159875), followed by a new successor ticket; do not reopen `#17784`.
- **Successor map citation:** The successor must cite this terminal review plus [D#17756 comment 18159875](https://github.com/orgs/neomjs/discussions/17756#discussioncomment-18159875) and inherit the salvage map above.
...
* **PR:** #17793
* **Target Issue:** #17784
* **Prior Review Comment ID:** [review 5025609485](https://github.com/neomjs/neo/pull/17793#pullrequestreview-5025609485)
* **Author Response Comment ID:** [comment 5418954953](https://github.com/neomjs/neo/pull/17793#issuecomment-5418954953)
