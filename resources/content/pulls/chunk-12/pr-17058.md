...
updatedAt: '2026-08-13T14:55:08Z'
closedAt: null
mergedAt: null
...
**Validation:** focused pre-fix falsifier red (`Expected: 38; Received: 39`); repaired touched-surface suite 148/148; both changed files pass `node --check`; `git diff --check` and restoration preflight pass.

CI status: pending on current head `b493b84b72`. Re-review request will follow once CI is green.
