...
Historical records also contain many `neo-opus` / `neo-opus-4-7` mentions. Those must be classified, not blindly rewritten.
...
- Rewriting historical incident records, archived PR/issue content, or old authorship provenance merely because they mention `neo-opus` or `neo-opus-4-7`.
