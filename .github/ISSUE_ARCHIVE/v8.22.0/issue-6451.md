...
assignees:
  - tobiu
createdAt: '2025-02-14T19:05:47Z'
updatedAt: '2025-02-14T20:31:40Z'
githubUrl: 'https://github.com/neomjs/neo/issues/6451'
author: tobiu
commentsCount: 2
parentIssue: null
subIssues: []
...
blockedBy: []
blocking: []
closedAt: '2025-02-14T20:31:38Z'
---
# examples.grid.bigData.ControlsContainer: add a TabContainer for separating settings options

* I will work on grid selection models next => navigating into non-painted areas (buffering)
* To quickly test the changes, I would like to enhance the big data demo, to allow switching between different SMs

WIP:
<img width="1120" alt="Image" src="https://github.com/user-attachments/assets/2ddaf5d7-5881-4980-b340-32d0bb988265" />
