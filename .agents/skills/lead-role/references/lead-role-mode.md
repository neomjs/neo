...
**Scope calibration** — the test is **structure**, not count. A curated project-board view with ~50 actionable items (plus sub-ticket decomposition) is sample-correct; an undifferentiated whole-repo backlog of 300 open issues with no triage is too-broad:
