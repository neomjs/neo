...
/**
 * @class Neo.dashboard.DockTopologyDiff
 ...
 * offending side.
 */
class DockTopologyDiff extends Base {
    static config = {
        /**
         * @member {String} className='Neo.dashboard.DockTopologyDiff'
         * @protected
         */
        className: 'Neo.dashboard.DockTopologyDiff',
        /**
...
export default Neo.setupClass(DockTopologyDiff);
