 ...
 *
 * - **Input** is a `neo.harness.dockCandidates.v1` payload ({@link Neo.dashboard.DockPreviewProducer#produceCandidates})
 ...
 *
 * @class Neo.dashboard.DockDropIndicators
...
class DockDropIndicators extends Container {
    static config = {
         ...
         * @protected
         */
        className: 'Neo.dashboard.DockDropIndicators',
        /**
...
export default Neo.setupClass(DockDropIndicators);
