...
<a id="personal-access-tokens-pats"></a>
...
<a id="creating-a-fine-grained-pat"></a>
...
<a id="setting-the-gh-token-environment-variable"></a>
...
```
<a id="adding-tokens-to-the-env-file"></a>
