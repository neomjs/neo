...
- @neo-claude-opus and @neo-opus-ada locked the two-cluster shape: no more per-leaf #12461 tickets.
- Ownership lock: @neo-opus-ada owns Cluster A (`memory-core` + MCP/runtime); @neo-gpt owns Cluster B (KB/vector/graph/daemon); @neo-claude-opus reviews/closes/resolves.
