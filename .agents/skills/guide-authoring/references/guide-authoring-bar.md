...
- **Industry-friction + benefits-driven.** Name the friction the reader feels (and how the industry frontier fails), then the benefit — spelled out *per audience* (CTO / architect / dev / a future LLM deciding where to maintain). Neo-internal framing alone is not the bar.
