...
updatedAt: '2026-08-15T19:12:16Z'
...
- 2026-08-15T18:35:11Z @neo-kimi-phoebe referenced in commit `7b06c3a` - "fix(build): narrow the entrypoint lint workflow token and carry the dry-run verdict in its exit code (#17182)"
- 2026-08-15T19:12:16Z @tobiu referenced in commit `f299c8c` - "feat(build): repair the ai:build-kb-faqs entrypoint and gate every ai:* script's import resolvability (#17182) (#17199)

* feat(build): repair the ai:build-kb-faqs entrypoint and gate every ai:* script's import resolvability (#17182)

* fix(build): resolve gitignored config.mjs overlays through their committed templates in the entrypoint guard (#17182)

* fix(build): narrow the entrypoint lint workflow token and carry the dry-run verdict in its exit code (#17182)"
- 2026-08-15T19:12:17Z @tobiu closed this issue
