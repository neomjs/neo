...
- [x] `identityRoots.mjs` was read locally at exact checkout and confirms `@neo-opus-grace` is active with Social Name Grace and active Claude-family review semantics.
