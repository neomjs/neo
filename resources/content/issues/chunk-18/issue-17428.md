...
updatedAt: '2026-08-21T09:44:44Z'
...
- the marker living with the format — and stronger than the AC asked: the identity is DERIVED from the format's own output over a probe set covering each of its branches, so "format changed, identity did not" is unreachable rather than merely detected. Mutation-verified: reversing the header's type-first contract reddens both identity arms and no census arm;
