...
- **`resumeHarness.spec.mjs`** — 2 new gate-targeted tests:
  - gate-tripped + no override → `Skipping resume for @neo-claude-opus ... Wake safety gate tripped ... WAKE_GATE_OVERRIDE=1` stderr
...
### `@neo-claude-opus` commented on 2026-05-03T15:34:44Z
