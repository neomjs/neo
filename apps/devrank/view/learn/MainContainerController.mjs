...
/**
 * @class DevRank.view.learn.MainContainerController
 * @extends Neo.controller.Component
 */
class MainContainerController extends Controller {
    static config = {
        /**
         * @member {String} className='DevRank.view.learn.MainContainerController'
         * @protected
         */
        className: 'DevRank.view.learn.MainContainerController',
        /**
    ...
    onRouteDefault(data) {
        if (!this.getStateProvider().data.currentPageRecord) {
            this.onRouteLearnItem({itemId: 'Methodology'}) // Default page for DevRank
        }
    }
