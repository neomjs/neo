...
/**
 * @class Neo.examples.grid.nestedRecordFields.MainContainerStateProvider
 * @extends Neo.state.Provider
 */
class MainContainerStateProvider extends StateProvider {
    static config = {
        /**
         * @member {String} className='Neo.examples.grid.nestedRecordFields.MainContainerStateProvider'
         * @protected
         */
        className: 'Neo.examples.grid.nestedRecordFields.MainContainerStateProvider',
        /**
