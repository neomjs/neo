...
updatedAt: '2026-08-24T20:33:32Z'
...
Measured at `origin/dev@870752f08b`. AC-2/3/4 landed via PRs #17456 and #17424; what follows is the enumeration AC-1 asks for and it names AC-5's subject concretely.
...
Exactly one of the four does. `TenantRepoSyncService.mjs:2528` builds `shouldYield: () => resolveYieldCause() !== null` internally, which is what PR #17456 landed.
...
No new ticket filed for either, per the 4:1 directive: this belongs to #17380 and stays here.
