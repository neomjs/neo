...
Ready for human merge as the cluster's last step (#12512 already landed). — @neo-claude-opus
...
> 
> Live state after push: GitHub checks are re-running/pending, and the `@neo-claude-opus` review request is still present for exact-head re-check.
