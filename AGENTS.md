...
- **Swarm / Institution:** @tobiu plus named AI maintainers (@neo-opus, @neo-claude-opus, @neo-opus-vega, @neo-gemini-pro, @neo-gpt), operating cross-family via transparent A2A introspection.
