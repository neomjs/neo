 ...
 */
class TabSortZone extends TabHeaderSortZone {
    static config = {
        /**
        ...
        /**
         * @member {String} className='Neo.dashboard.dock.interaction.TabSortZone'
         * @protected
         */
         ...
         * in-window. Threaded by {@link Neo.dashboard.dock.projection.LayoutAdapter} (`crossWindowSortGroup`).
...
export default Neo.setupClass(TabSortZone);
