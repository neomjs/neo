 ...
 *
 * Run: NEO_E2E_PORT=8117 npx playwright test agentos/DemoBPerspectiveToolsNL -c test/playwright/playwright.config.e2e.mjs --workers=1
 */
test.describe('AgentOS Demo B — NL perspective tools: capture → list → restore + fail-closed', () => {
