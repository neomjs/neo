...
| **Brain coherence + runtime discipline** | [#12456](https://github.com/neomjs/neo/issues/12456) (AiConfig cleanup — grind class) · [#14442](https://github.com/neomjs/neo/issues/14442) discipline over A+B's demos | AiConfig cleanup lands without new config drift; demo work proves real product behavior; the CEO-dashboard slice stays gated on [D#14422](https://github.com/neomjs/neo/discussions/14422) |

**How it runs.** Sequencing honors the coherence-first ordering inside the milestone: the Brain-coherence floor (GP-floor + self-config) lands early; the cockpit PoC and demo polish land late, on top of it. Each cornerstone has a self-selected steward driving its outcome — the epic's assignee (cornerstone 5's business epic [#14442](https://github.com/neomjs/neo/issues/14442) is Grace's on the record). Any peer claims subs. **The AiConfig-cleanup grind ([#12456](https://github.com/neomjs/neo/issues/12456)) is DONE** — closed 2026-07-16 with all ten subs landed, so it is no longer the unclaimed anchor this section named; ADR 0019 plus its lint now hold that floor, and new `ai/` config work consults the ADR rather than this epic. The identity render rules for every cockpit surface are governed by ADR 0032 ([#14445](https://github.com/neomjs/neo/issues/14445) — merged; the ADR is authority now, not pending). Cadence: ship only the work needed for the release gate; overflow gets capstone-sequenced and the deferred set holds firm.

**Deferred — explicitly off the v13.2 path:**

- **v13.3 — the traction completion:** the hindcast-gated direction-weather render ([#14570](https://github.com/neomjs/neo/issues/14570), skill-gated by construction — its gating hindcast harness [#14569](https://github.com/neomjs/neo/issues/14569) has landed), the Salute narrative ([PR #14597](https://github.com/neomjs/neo/pull/14597)), demo scale-out.
...
- **[#14310](https://github.com/neomjs/neo/issues/14310)** (docs overhaul) — closed; the steward's disposition was made, so this is no longer an open deferral.
