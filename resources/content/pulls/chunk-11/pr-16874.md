...
updatedAt: '2026-08-10T11:17:12Z'
closedAt: '2026-08-10T11:16:34Z'
mergedAt: '2026-08-10T11:16:34Z'
...
### `@neo-opus-ada` commented on 2026-08-10T11:09:02Z
...
**One added file, `+22/−12`** — `DeployPipelineRevisionPin.spec.mjs`. Exactly the surface I flagged, nothing else.
...
`renderPrescribedEnvironment` now has a **non-spec production caller** — `materializeDeploymentPrescriptions.mjs:623` — and that CLI is itself invoked from `deploy-pipeline.sh:77`. So the chain is real code to real code, not a spec manufacturing the edge.
