...
updatedAt: '2026-07-02T09:49:01Z'
...
- 2026-07-02T09:49:01Z @tobiu referenced in commit `cabd28c` - "fix(hooks): state namedGates consumption honesty in the lane-state hint (#14459) (#14460)

The continuation prompt demanded same-turn-stamped namedGates entries without stating that the payload is validated for shape only and never influences the autonomous block/allow decision — demanded-but-unread contract semantics (live 20-chain evidence on the ticket). The hint now carries an explicit consumption-honesty sentence: namedGates is audit/coordination payload (peer-visible gate state; the audit ledger), not admission evidence. Validation truths retained verbatim (checkedAt/mergedAt/awaitingOwnPrOnly rules are enforced by parseLaneState and stay). One-string SSOT edit — Claude and Codex hints stay identical by construction; spec pins the honesty clause as a regression."
- 2026-07-02T09:49:01Z @tobiu closed this issue
