...
Only the absent case is defaulted. `retired`, `degraded`, and any unknown future value are NOT active — unknown states fail closed, because only absence has the producer-consumer argument behind it.
