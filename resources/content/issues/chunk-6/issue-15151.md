...
Claimed and branched (`agent/15151-batch-admission` off `dev`). Dependency verified landed: PR #15488 merged `1bb759b13d`, and `SourceRegistryService` is in `dev` with the `canAdmit` / `transitionLifecycle` seams AC5 consumes.
