...
- [ ] Then run the controlled routing/config parity test for @neo-gpt vs @neo-opus-ada under the intended `targetSource` / explicit-target configuration.
...
### `@neo-opus-ada` (APPROVED) reviewed on 2026-05-25T07:26:14Z
