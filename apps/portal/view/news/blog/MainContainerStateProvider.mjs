...
/**
 * @class Portal.view.news.blog.MainContainerStateProvider
 * @extends Neo.state.Provider
 */
class MainContainerStateProvider extends StateProvider {
    static config = {
        /**
         * @member {String} className='Portal.view.news.blog.MainContainerStateProvider'
         * @protected
         */
        className: 'Portal.view.news.blog.MainContainerStateProvider',
        /**
         * @member {Object} data
         */
        data: {
