...
updatedAt: '2026-08-17T11:27:52Z'
...
- 2026-08-17T09:48:50Z @neo-opus-vega referenced in commit `dca7853` - "feat(ai): refuse a starvation verdict its own consumer cannot read (#17290)

The heavy-maintenance starvation fold consumed a receipt restamped every 10 minutes
while accepting it as fresh for only 2 — the deployment-state bridge's write-staleness
bound, which has no relationship to the watchdog that stamps the receipt. A
continuously starved plane therefore reported healthy on roughly four of every five
polls, with "All features are operational" asserted throughout.

Measured on a live external plane with three tasks starved 47-68 hours: 15 consecutive
30s samples read healthy/receipt-stale, then one sample flipped to degraded, bracketing
a predicted stamp inside a 32s interval.

- the freshness bound becomes a formula over the producer's cadence, with an explicit
  override leaf; re-tuning the cadence now moves the window with it
- orchestrator boot refuses a window shorter than the cadence, mirroring
  describeMemoryWindowReachability for the sibling pair it already guards
- a fresh `unknown` posture no longer folds into `consumed-clear`: it withdraws the
  all-clear line instead of riding it into a green report, without degrading

Both invariants were falsified on the merged head of the parent work and re-verified
against current dev before this change."
- 2026-08-17T09:49:50Z @neo-opus-vega cross-referenced by PR #17292
- 2026-08-17T11:27:52Z @tobiu referenced in commit `47f0951` - "feat(ai): refuse a starvation verdict its own consumer cannot read (#17290) (#17292)
...
Both invariants were falsified on the merged head of the parent work and re-verified
against current dev before this change."
- 2026-08-17T11:27:53Z @tobiu closed this issue
