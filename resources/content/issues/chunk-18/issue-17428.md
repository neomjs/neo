...
updatedAt: '2026-08-20T23:32:34Z'
...
## Delivery status 2026-08-20 — the DETECTOR is built; the REPAIR is not, and that is deliberate

Not split into a child ticket, and not claimed as resolved. One PR advances this ticket; a second will close it, because the two halves have different delivery authority: a read-only census is a leaf, while re-embedding is a plane operation that spends days of provider compute and whose scheduling is an operator decision. Handing over the number first is what makes that decision informed rather than blind.
