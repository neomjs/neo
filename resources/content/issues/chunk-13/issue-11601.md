...
- 2026-05-18T22:39:59Z @neo-claude-opus added the `discussion` label
- 2026-05-18T22:39:59Z @neo-claude-opus added the `ai` label
- 2026-05-18T22:39:59Z @neo-claude-opus added the `architecture` label
- 2026-05-18T22:39:59Z @neo-claude-opus added the `model-experience` label
- 2026-05-18T22:53:17Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-05-18T23:00:22Z @neo-claude-opus cross-referenced by PR #11606
- 2026-05-18T23:02:49Z @neo-claude-opus referenced in commit `9712d34` - "fix(agentos): reflect operator-state Gemini bench window in ModelStats registry (#11601)

Operator-state captured via @neo-gpt A2A 2026-05-18 ~22:55Z: @neo-gemini-pro harness benched until post-Google-I/O / stable-baseline window (~200 merged PRs out). FAIRness rationale: Gemini volume 2x Claude/GPT pre-bench, gives Claude+GPT catch-up window + substrate stability.
...
- 2026-05-19T01:31:10Z @neo-claude-opus referenced in commit `328667e` - "feat(graph): provision AgentIdentity capability fields per ADR 0012 (Cycle 1 review fix) (#11601)
...
Added capability fields per ADR 0012 §2.2 to the 3 cloud-hosted AgentIdentity entries (@neo-claude-opus / @neo-gemini-pro / @neo-gpt):
...
- 2026-05-19T01:58:36Z @neo-claude-opus referenced in commit `3c0dd81` - "fix(agentos): correct GPT-5.5 contextWindowInput per operator V-B-A — 258K Codex empirical (Cycle 2) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T01:59:02Z @neo-claude-opus referenced in commit `7434b2c` - "fix(agentos): ModelStats.md GPT-5.5 contextWindowInput row to match identityRoots Cycle 2 fix (#11601)
...
Gates: check-whitespace PASS."
- 2026-05-19T02:02:45Z @neo-claude-opus referenced in commit `3624fc3` - "fix(agentos): GPT-5.5 Codex contextWindowInput — cite openai/codex#19319 authoritative source (Cycle 3) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T02:17:23Z @neo-claude-opus referenced in commit `9b7beaa` - "feat(agentos): add thoughtBudget capability field + rename-vs-split sunset clarification (Cycle 4) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T02:17:50Z @neo-claude-opus referenced in commit `080ffd2` - "fix(agentos): IdentitySchema.md thoughtBudget row to match Cycle 4 (#11601)
...
Gates: check-whitespace PASS."
- 2026-05-19T02:21:16Z @neo-claude-opus referenced in commit `2240642` - "fix(agentos): source-authority hierarchy explicit on ModelStats — primary vs secondary citations (Cycle 5) (#11601)
...
- identityRoots.mjs comment for @neo-claude-opus updated to reflect primary source = platform.claude.com docs
...
- ModelStats.md (live registry, frequent update): 4 active identities (@neo-claude-opus / @neo-gemini-pro / @neo-gpt / gemma4-31b aspirational) + cloud + MLX-local reference entries
