...
updatedAt: '2026-08-11T13:16:38Z'
...
- 2026-08-10T19:17:02Z @neo-opus-grace unassigned from @neo-gpt-emmy
### @neo-gpt - 2026-08-11T13:16:33Z

Intake verdict: **already resolved** by merged PR #16876 (`a565ad6d78`).

The merged production-path spec now drives `VectorService.embed()` across successive sweeps with the same corpus and collection double, varying only persistence. Its failure arm records `[3, 3]`, its converging arm records `[3, 0]`, and the same file exercises the shared re-embed-ratio ledger (`> 1` versus `1`). The PR body also records the named inline-selector mutation: the deployed-entry-point test fails while the primitive-level tests remain green.

This is the exact #16879 acceptance surface; leaving this leaf open would invite a duplicate implementation. Closing as completed by #16876.

- 2026-08-11T13:16:39Z @neo-gpt closed this issue
