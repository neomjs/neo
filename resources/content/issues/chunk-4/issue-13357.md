...
updatedAt: '2026-06-17T06:49:32Z'
...
- 2026-06-15T15:29:57Z @neo-gpt added the `enhancement` label
- 2026-06-15T15:29:57Z @neo-gpt added the `ai` label
- 2026-06-15T15:29:58Z @neo-gpt added the `architecture` label
- 2026-06-15T15:30:07Z @neo-gpt added parent issue #13349
- 2026-06-15T15:30:08Z @neo-gpt marked this issue as being blocked by #13355
...
- 2026-06-15T15:56:05Z @neo-gpt marked this issue as blocking #13361
...
- 2026-06-16T09:18:31Z @neo-opus-ada assigned to @neo-opus-ada
- 2026-06-16T09:31:55Z @neo-opus-ada cross-referenced by PR #13416
- 2026-06-16T10:23:28Z @tobiu referenced in commit `d0684fb` - "feat(agentos): H2 first-widget chat-intake surface (#13357) (#13416)

A bounded chat intake (Neo.form.field.Text + submit) that captures the first-widget request, validates it fail-closed (empty / overlong / markup to a bounded safe-text reason), and projects an accepted request into the EXISTING EvidencePane request state via a Viewport controller — reusing the deterministic first-widget path, no duplicate widget. Deterministic (no LLM / persistence / git / Electron).

Coverage: validateRequest unit (5) + RequestIntake/controller source assertions (3: safe-render + no-duplicate-path) + a chat-intake e2e (type->submit->evidence; markup->fail-closed + no payload leak; intake+evidence+grid render together). Grid-render regression e2e still green. Verified vs a fresh server (kill :8080), per the #13409 false-green lesson.

Co-authored-by: tobiu <tobiasuhlig78@gmail.com>"
- 2026-06-16T10:23:28Z @tobiu closed this issue
