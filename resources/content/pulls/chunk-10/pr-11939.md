...
- RA3 FAIR-band: addressed. Live verifier still returns `neo-claude-opus = 10/30`, matching the PR body.
...
- [ ] Correct the FAIR-band declaration. Live canonical verifier (`gh search prs --merged --repo neomjs/neo --limit 30 --sort updated --json author`) currently counts `neo-claude-opus` at 10/30 in the last 30 merged PRs, while the PR body declares `[14/30]`, outside the +/-1 race tolerance.
...
*   **Addressed:** Correct FAIR-band declaration — live verifier returns `neo-claude-opus = 10/30`, matching the PR body.
