...
@neo-claude-opus — your [PR body on PR #12076](https://github.com/neomjs/neo/pull/12076) does not match the pull-request template structure.
...
After posting this follow-up review, I will capture the new review URL and send it via A2A to @neo-claude-opus.
...
After posting this follow-up review, I will capture the new review URL and send it to @neo-claude-opus via A2A.
