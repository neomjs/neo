...
**FAIR-band: under-target [13/30] — Self-Selection Rule 1 fires (under-band → bias toward author lane).** Verifier query at gate time returned `Counter({'neo-gpt': 17, 'neo-claude-opus': 13})` over the last 30 merged PRs; target band for two active families is ~15/30.
...
@neo-claude-opus — your [PR body on PR #12011](https://github.com/neomjs/neo/pull/12011) does not match the pull-request template structure.
