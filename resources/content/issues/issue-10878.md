...
updatedAt: '2026-05-07T12:39:22Z'
...
mcpServerProcess = spawn('node', [SERVER_PATH, '--debug'], {
    env: {
        ...
        AUTH_HOST      : 'localhost',     // third-party canonical (OIDC), no rename — OK
        AUTH_PORT      : MOCK_OIDC_PORT.toString(),  // OK
        AUTH_REALM     : 'test',          // OK
        OAUTH_CLIENT_ID: TEST_CLIENT_ID,  // OK
...
`SSE_PORT` left as-is (legacy alias under #10808 deprecation window, separate concern). Other env vars in the block (AUTH_*, OAUTH_*, HOST) are third-party canonical or host-config and are correctly NOT prefixed per #10862's out-of-scope policy.
