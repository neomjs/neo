...
- **Static Diff Hallucination (#10500):** Agent approved a PR without checking out the branch and running tests locally, relying solely on static diff analysis to assess `[EXECUTION_QUALITY]`. Falsifying tool not used: `checkout_pull_request` + test execution *before* asserting success.
