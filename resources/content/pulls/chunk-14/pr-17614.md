...
updatedAt: '2026-08-23T14:43:14Z'
closedAt: null
mergedAt: null
...
|---|---|
| AC-1 | Not delivered here — discharged by #17538 / PR #17531, which promoted the splitter's affordance out of the app layer. Verified still true: the engine paints `.neo-dashboard-dock-splitter` from `--dock-splitter-*` with hover/active states. |
