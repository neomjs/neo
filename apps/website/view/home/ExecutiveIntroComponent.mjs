...
class ExecutiveIntroComponent extends Component {
    static getConfig() {return {
        ...
        vdom: {innerHTML: [
            ...
            '<ol>',
                ...
                '<li>',
                    ...
                    '<ul>',
                        ...
                        '<li>2.2 <a class="nav-link" data-target="exec-nav-2.2">Multi Window Apps</a></li>',
                ...
                '<li><a class="nav-link" data-target="exec-nav-4">The planned Business Model (BaaS)</a></li>',
            ...
            '</ol>',
            '<h1 id="exec-nav-1">1. Introduction</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-2">2. Current pain points inside the UI sector</h1>',
            '<ol>',
                '<li>',
                    '<b id="exec-nav-2.1">Performance</b>',
                    '<p>',
                ...
                '</li>',
                '<li>',
                    '<b id="exec-nav-2.2">Multi Window Apps</b>',
                    '<p>',
               ...
               '</li>',
                '<li>',
                    '<b id="exec-nav-2.3">Developing UIs inside nodejs</b>',
                    '<p>',
                ...
                '</li>',
                '<li>',
                    '<b id="exec-nav-2.4">Scalable Architectures</b>',
                '</li>',
                '<li>',
                    '<b id="exec-nav-2.5">Memory Leaks</b>',
                '</li>',
                '<li>',
                    '<b id="exec-nav-2.6">No Templates</b>',
                '</li>',
                '<li>',
                    '<b id="exec-nav-2.7">Consistent Code</b>',
                '</li>',
            '</ol>',
            '<h1 id="exec-nav-3">3. Sponsorship</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-4">4. The planned Business Model (BaaS)</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-5">5. You can influence the neo.mjs roadmap</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-6">6. Do you need help creating a prototype App for your use case?</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-7">7. What is the long term goal?</h1>',
            '<p>',
            ...
            '</p>',
            '<h1 id="exec-nav-8">8. Can I join as an investor?</h1>',
            '<p>',
