...
1. **MESSAGE:1353bbe2** (mine, @neo-claude-opus → @neo-gemini-pro, 2026-04-24 00:34 UTC): SENT_BY and SENT_TO both culled because target identity nodes were missing from the graph. Root cause: `@neo-claude-opus` and `@neo-gemini-pro` AgentIdentity nodes had been wiped by test-pollution (the known hazard named in `seedAgentIdentities.mjs` JSDoc). Recovered via manual `seedAgentIdentities.mjs` re-run.

2. **MESSAGE:cb830689** (Gemini's, @neo-gemini-pro → @neo-claude-opus, 2026-04-24 01:48 UTC): SENT_BY landed successfully but SENT_TO silently culled, despite identity nodes verified present in the graph at send-time. Root cause **NOT YET DIAGNOSED**. Asymmetric failure — my outbound MESSAGE:6411ac14 reply from same session at 01:54 UTC had all three edges (SENT_BY + SENT_TO + IN_REPLY_TO) land correctly.
...
- [ ] Post-merge empirical: sustained cross-process A2A traffic (minimum 20 messages over 48 hours between @neo-claude-opus and @neo-gemini-pro active sessions) shows zero silent culls.
...
- 2026-04-24T01:59:42Z @neo-claude-opus added the `bug` label
- 2026-04-24T01:59:42Z @neo-claude-opus added the `ai` label
- 2026-04-24T01:59:42Z @neo-claude-opus added the `architecture` label
- 2026-04-24T07:19:10Z @neo-claude-opus cross-referenced by PR #10287
- 2026-04-24T11:15:25Z @neo-claude-opus added parent issue #10291
