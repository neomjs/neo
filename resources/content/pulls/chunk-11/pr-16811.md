...
updatedAt: '2026-08-09T19:41:33Z'
closedAt: null
mergedAt: null
...
- **New guard** `test/playwright/unit/ai/deploy/HeapObservationChannelMount.spec.mjs`, 3 tests (base channel at the config-authoritative path / reader `:ro` / parity profile at its pinned path), green at `94559749d7`.
- **Mutation-convicted, eleven arms** (each run at the current head; a guard that cannot red against the defect class is not evidence):
