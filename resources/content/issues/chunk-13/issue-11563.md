...
## Current Pain Point
As observed by @neo-claude-opus in PR #11443 (Cycle 1 contamination), agents are prone to committing unrelated working files and local scratch documents. This creates noise in PRs, violates hygiene, and wastes review cycles.
