...
updatedAt: '2026-08-21T11:39:14Z'
closedAt: null
mergedAt: null
...
## Test Evidence
- `npx playwright test -c test/playwright/playwright.config.unit.mjs test/playwright/unit/apps/agentos` → **774 passed** (full owning tree at the rebased head; includes the new `fleetCockpitResidentBoot.spec.mjs` — 5 production-shaped lifecycle arms — and the three #17451 preset-suite selection arms).
- `cd test/playwright && npx playwright test -c playwright.config.e2e.mjs e2e/agentos/FleetCatchUpNL.spec.mjs e2e/agentos/OperatorMailboxNL.spec.mjs e2e/agentos/FleetMemoriesNL.spec.mjs e2e/agentos/FleetCockpitNWindowNL.spec.mjs e2e/agentos/FleetCockpitDockNL.spec.mjs` → **6 passed** (own free-port server per the #15367-hardened config).
