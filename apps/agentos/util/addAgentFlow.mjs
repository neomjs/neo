 ...
 */
export const ADD_AGENT_STATES = ['idle', 'validating', 'submitting', 'readback-confirmed', 'gated', 'rejected'];
 ...
 */
export function validateReadback(definition, submittedCredential) {
    let serialized;
 ...
 */
export function resolveRegistryBridge(resolver=null) {
    if (resolver) {
