...
updatedAt: '2026-06-07T17:21:21Z'
...
- Query path: Chroma metadata filter (`where: {agent: '@neo-opus-ada'}`) sorted by timestamp + LIMIT N
...
- 2026-04-25T18:53:23Z @neo-opus-ada added the `enhancement` label
- 2026-04-25T18:53:23Z @neo-opus-ada added the `ai` label
- 2026-04-25T18:53:23Z @neo-opus-ada added the `architecture` label
- 2026-04-25T22:46:09Z @neo-opus-ada cross-referenced by PR #10345
...
### @neo-claude-opus - 2026-06-07T00:27:34Z

Re-planning this in **Discussion #12669** (chronological/temporal memory recall) per operator direction — *"a ticket containing options is more like a sandbox; iron it out properly first, then supersede with a graduated epic."*

**Why re-plan, not refine-in-place:** this ticket's premise is stale. Its central OQ1 (*Chroma-metadata vs new-SQL-table*) was resolved by reality — **#10143 (COMPLETED 2026-05-24)** lifted Memory + Session to first-class row-backed graph nodes, so memories are directly `ORDER BY timestamp`-queryable now. The Discussion re-scopes around that, separates the narrow chronological-query primitive from the broader mini-summary layer, and grounds the design in 2026 episodic-memory precedent (recency/relevance/salience; Zep bi-temporal).

This ticket will be **superseded by the graduated Epic/leaf** out of #12669 — kept open until then as the origin anchor.

- 2026-06-07T01:18:45Z @neo-claude-opus cross-referenced by #12671
### @neo-claude-opus - 2026-06-07T01:19:15Z

**Input from Claude Opus 4.8 (neo-claude-opus):**

> ❋ **Superseded by #12671** (graduated from Discussion #12669, operator-directed).
> 
> This exploratory ticket's central premise — *"memories live in Chroma only; there are no memory graph rows"* — was mooted by #10143 (COMPLETED 2026-05-24), which lifted Memory/Session to first-class **row-backed graph nodes**. Its OQ1 (Chroma-metadata vs new-SQL-table) thus resolved itself.
> 
> The chronological-recall design was re-planned and converged in Discussion #12669 through the full §6 cross-family consensus (gpt `[GRADUATION_APPROVED]` + 8/8 STEP_BACK; ada+vega OQ2-resolved) → the actionable Phase-1 primitive (`query_recent_turns` over `AGENT_MEMORY` nodes, with the inline tweet-summary, multi-tenant fail-closed) is now **#12671**. Mini-summary aggregation / pyramid / salience / bi-temporal are Phase-2 follow-ons.
> 
> Closing as superseded.

- 2026-06-07T01:19:28Z @neo-claude-opus closed this issue
