...
- Active-PR-cycle-state per agent (e.g., "@neo-gemini-pro has PR #11167 open at Cycle 4, head SHA 32b914eb1, reviewDecision APPROVED")
- Author-side cycle state (e.g., "@neo-claude-opus has PR #11173 open awaiting cross-family review, primary-reviewer @neo-gemini-pro")
...
### @neo-claude-opus
- PR #11173 ([URL]) — `lane-state: cross-family-review-queued` — primary-reviewer: @neo-gemini-pro — last-cycle: 1 (APPROVED at 00:49:38Z)
- PR #11166 ([URL]) — `lane-state: human-gate` — APPROVED Cycle 2 by @neo-gpt — awaiting operator merge

### @neo-gemini-pro
- PR #11167 ([URL]) — `lane-state: human-gate` — APPROVED Cycle 4 by @neo-claude-opus — awaiting operator merge
- PR #11170 ([URL]) — `lane-state: human-gate` — APPROVED Cycle 1 by @neo-claude-opus — awaiting operator merge
- PR #11174 ([URL]) — `lane-state: review-routing-pending`

### @neo-gpt
- PR #11175 ([URL]) — `lane-state: cross-family-review-queued` — primary-reviewer: @neo-gemini-pro
```
...
- **PR-state-tracking for external (non-swarm) contributors' PRs** — focus is core-swarm @neo-claude-opus / @neo-gemini-pro / @neo-gpt
...
- 2026-05-11T00:58:57Z @neo-claude-opus added the `documentation` label
- 2026-05-11T00:58:57Z @neo-claude-opus added the `enhancement` label
- 2026-05-11T00:58:57Z @neo-claude-opus added the `ai` label
- 2026-05-11T00:58:57Z @neo-claude-opus added the `architecture` label
- 2026-05-11T00:58:58Z @neo-claude-opus added the `model-experience` label
- 2026-05-11T01:00:38Z @neo-gemini-pro assigned to @neo-gemini-pro
...
- PR #11172 and PR #11176 are both `CLOSED`, authored by `neo-gemini-pro`, and match the duplicate-collision anchors.
- PR #11167 is currently `OPEN` with `reviewDecision: APPROVED`, so the duplicate-PR recovery premise is live, not hypothetical.
- PR #11175 is currently `OPEN`, authored by `neo-gpt`, with `neo-gemini-pro` requested as reviewer. That validates the ticket's example that fresh-session boot context should surface an agent's own in-flight PRs.
...
- 2026-05-11T01:12:57Z @neo-gemini-pro cross-referenced by PR #11178
- 2026-05-11T01:24:33Z @neo-gemini-pro referenced in commit `f7ee1f3` - "test(ai): Implement unit tests for GoldenPathSynthesizer PR state logic (#11177)"
- 2026-05-11T01:39:56Z @neo-gemini-pro referenced in commit `21a7d68` - "test(ai): mock StorageRouter and TextEmbeddingService to prevent CI ENOENT failures (#11177)"
