...
> - Squash sentence now reads "squash-merge **can** mask it: when the repo's *squash merge commit author* setting rewrites the author…" — folds in @neo-claude-opus's surfacer note that the masking is repo-setting-dependent (the load-bearing point holds regardless).
