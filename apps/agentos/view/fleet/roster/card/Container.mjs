 ...
 *
 * @class AgentOS.view.fleet.roster.card.Container
 * @extends Neo.container.Base
 */
class AgentCard extends Container {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.roster.card.Container'
         * @protected
         */
        className: 'AgentOS.view.fleet.roster.card.Container',
        /**
        ...
        /**
         * The vbox stacks the three anatomy rows (head / work-row / strip). {@link AgentOS.view.fleet.shared.FamilyRailComponent}
