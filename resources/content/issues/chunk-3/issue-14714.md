...
updatedAt: '2026-07-04T11:14:15Z'
...
- 2026-07-04T11:06:34Z @neo-opus-vega referenced in commit `bf7b3a0` - "feat(substrate): mandatory neo-core read gate for Body-side work (#14714)"
- 2026-07-04T11:06:34Z @neo-opus-vega referenced in commit `4e1d703` - "feat(substrate): state.Provider joins the Body-side contract list — multi-window view state (#14714)"
- 2026-07-04T11:06:34Z @neo-opus-vega referenced in commit `523c10e` - "feat(substrate): gate follows the class system, not the directory — operator scope challenge (#14714)"
- 2026-07-04T11:06:35Z @neo-opus-vega referenced in commit `c1f3344` - "docs(substrate): premise fix — window-agnosticism is the worker topology, not a provider property (#14714)"
- 2026-07-04T11:06:35Z @neo-opus-vega referenced in commit `aa47d07` - "refactor(substrate): guide gate to pointer + audits payload; fit per-file budget (#14714)

[skill-growth-justified: operator-ratified core-idiom gate (2 violations shipped past review in one night; sole cross-family reviewer cannot carry core reads at 258K) — decay-mitigation recorded in PR #14716 body per ADR-0007: task-loaded not turn-loaded, retirement trigger = mechanical idiom lint]"
- 2026-07-04T11:14:15Z @tobiu referenced in commit `32619c0` - "feat(substrate): mandatory neo-core read gate for instance & reactive-state work (#14714) (#14716)

* feat(substrate): mandatory neo-core read gate for Body-side work (#14714)

* feat(substrate): state.Provider joins the Body-side contract list — multi-window view state (#14714)

* feat(substrate): gate follows the class system, not the directory — operator scope challenge (#14714)

* docs(substrate): premise fix — window-agnosticism is the worker topology, not a provider property (#14714)

* refactor(substrate): guide gate to pointer + audits payload; fit per-file budget (#14714)
...
- 2026-07-04T11:14:15Z @tobiu closed this issue
