...
updatedAt: '2026-07-04T12:21:43Z'
closedAt: null
mergedAt: null
...
This demo/falsifier leaf for the Convergence-weighted Golden Path epic (#14581) runs the full chain — snapshot schema (merged) → weighting compute (merged) → render-ledger (PR #14725) — on a seeded startup goal-lattice across four imagined strategy futures, proving the lane-goal rather than leaving the schema/compute/render leaves as unfalsified machinery. Epic closeout remains pending until #14725 and #14732 both clear the merge gate.
...
Related: epic #14581 (closeout pending after #14725 and #14732 both clear the merge gate) · #14633 (schema, merged) · #14707 (compute, merged) · #14636 / PR #14725 (render-ledger, the chain link this stacks on) · demo-leaf-per-epic rule (D#14561).
