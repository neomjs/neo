...
9.  **The Reflection Phase & Hard Stop:** Upon creating the PR, you MUST execute the `pr-review` skill to formally critique your own implementation (checking for architectural alignment and JSDoc completeness). Push any minor corrective commits immediately. Finally, post your review metrics to the PR and HALT. You MUST NOT autonomously merge the PR. A Human Approver will eventually Squash Merge the code to preserve the Fat Ticket natively.
