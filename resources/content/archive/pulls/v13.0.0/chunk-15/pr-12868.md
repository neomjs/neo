...
updatedAt: '2026-06-21T13:53:04Z'
...
- **Related:** my #12832 (no-error-key invariant, preserved); the the tenant cloud deployment (local gemma → 300s by construction, supersedes my proposed override); the `--migrate-config` freshness thread (#12867, my #12858 dedup gate).
