...
/**
 * @class AgentOS.view.fleet.instances.ManagerContainer
...
class InstanceManager extends Container {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.instances.ManagerContainer'
         * @protected
         */
        className: 'AgentOS.view.fleet.instances.ManagerContainer',
        /**
