...
updatedAt: '2026-05-07T07:24:22Z'
...
- `OAUTH_CLIENT_ID`, `OAUTH_CLIENT_SECRET` (OAuth standard)
- `AUTH_HOST`, `AUTH_PORT`, `AUTH_REALM`, `AUTH_ISSUER_URL`, `AUTH_TRUST_PROXY_IDENTITY` (Keycloak/OIDC adjacent)
...
- Renaming third-party-canonical names (GH_TOKEN, GEMINI_API_KEY, AUTH_*, OAUTH_*) — these follow upstream conventions; leave alone
