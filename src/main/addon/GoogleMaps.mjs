...
/**
 * The global the Maps bootstrap invokes once `google.maps` is populated. Google resolves this
 * parameter as a path on `globalThis`, so it must be a real name rather than a function reference.
 * @type {String}
 */
