...
/**
 * @summary Canonical thin singleton for GitLab Workflow configuration.
 *
 * Defaults and formulas live in {@link Neo.ai.mcp.server.gitlab-workflow.ConfigBase}; this class
 ...
 * @extends Neo.ai.mcp.server.gitlab-workflow.ConfigBase
 * @singleton
 */
