...
updatedAt: '2026-08-19T17:38:31Z'
closedAt: null
mergedAt: null
...
| `DEVINDEX_PUBLISH_BUCKET` (what devindex WRITES) | `gs://neomjs-middleware-dist/dist/devindex` |
...
| `https://storage.googleapis.com/neomjs-middleware-dist/dist/devindex/…` | **HTTP 403** — bucket is private, mounted into Cloud Run |
...
Unrelated to the diff but same ticket: devindex's first scheduled run failed outright (untracking the working set removed the directory; git cannot express an empty one). Fixed in devindex@c6b73f0, and a full collection is running green on the shipped tree as I write this.
