...
7. **Author on the Epic's first sub-tickets identified** — probably `@tobiu` for the Tenets v0 authoring, `@neo-claude-opus` + `@neo-gemini-pro` split on the programmatic primitives.
