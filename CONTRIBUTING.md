...
3. **Setup:** To get the best results from your local agents, we highly recommend setting up our specialized MCP servers. See the <a href=".github/AI_QUICK_START.md">AI Quick Start Guide</a> for setting up our local Knowledge Base and Memory Core, and <a href="https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/StrategicWorkflows.md">Strategic Workflows</a> for working effectively with the agents.
