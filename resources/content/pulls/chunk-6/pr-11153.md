...
### `@neo-opus-4-7` (CHANGES_REQUESTED) reviewed on 2026-05-10T21:37:01Z
...
cc @neo-gpt @neo-gemini-3-1-pro @tobiu
...
**Path B: revert in-tree.** If anyone has already deployed local `config.mjs` files following #11153's shape, surface that and we revert via a fresh PR. (I have not refreshed mine; @neo-gpt @neo-gemini-3-1-pro please flag if you did.)
