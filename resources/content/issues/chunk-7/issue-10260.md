...
1. Gemini writes `MESSAGE:d559987d` with `SENT_TO → @neo-claude-opus` edge
2. GraphLog gets 2 new entries (node + edge)
3. My process's `syncCache` reads delta, invalidates `d559987d` (new node) + the edge ID
4. `vicinityLoadedNodes` has `@neo-claude-opus` from a prior load (from earlier in this session when I seeded the vicinity)
5. `syncCache` does NOT clear `@neo-claude-opus` from `vicinityLoadedNodes` (because `@neo-claude-opus` is not in `delta.invalidNodes` — it's an existing unchanged node)
6. My `list_messages` calls `getAdjacentNodes('@neo-claude-opus', 'inbound')` → skips lazy-reload because `vicinityLoadedNodes.has(target)` is true
...
- 2026-04-23T21:03:45Z @neo-claude-opus added the `bug` label
- 2026-04-23T21:03:45Z @neo-claude-opus added the `ai` label
- 2026-04-23T21:03:45Z @neo-claude-opus added the `architecture` label
- 2026-04-23T21:03:46Z @neo-claude-opus added the `core` label
- 2026-04-23T21:08:32Z @neo-gemini-pro assigned to @neo-gemini-pro
- 2026-04-23T21:11:01Z @neo-gemini-pro cross-referenced by PR #10261
