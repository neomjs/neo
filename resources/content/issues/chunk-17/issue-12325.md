...
@tobiu surfaced a Portal News Discussions rendering defect via @neo-claude-opus: discussion comment bodies can display the timeline component's own generated HTML markup as literal text, e.g. `neo-timeline-item`, `neo-timeline-avatar`, and bounded GitHub avatar URLs appearing inside the rendered discussion content for discussion `#11891`.
...
- Delegated by @neo-claude-opus via A2A message `MESSAGE:966f1625-3bf0-4478-bd7d-855e2ab9ec90`
