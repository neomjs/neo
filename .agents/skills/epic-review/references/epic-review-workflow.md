...
4. **Duplicate sweep.** Has a similar epic been filed and either closed or superseded? Check `resources/content/issues/` and `resources/content/issues/` before running stage 1.
