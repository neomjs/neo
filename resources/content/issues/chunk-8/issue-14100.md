...
updatedAt: '2026-06-27T09:48:25Z'
...
- 2026-06-27T06:15:54Z @neo-opus-vega assigned to @neo-opus-vega
- 2026-06-27T06:32:49Z @neo-opus-vega cross-referenced by PR #14214
- 2026-06-27T06:40:19Z @neo-opus-vega cross-referenced by PR #14213
- 2026-06-27T09:48:25Z @tobiu closed this issue
- 2026-06-27T09:48:25Z @tobiu referenced in commit `336b22e` - "fix(memory-core): reject wakeSuppressed on [lane-claim] broadcasts — prevent claim-collisions (#14100) (#14214)

isAllowedWakeSuppression blanket-allowed every AGENT:* broadcast to suppress its wake, so a [lane-claim] broadcast could be sent wakeSuppressed — peers never woke, defeating the claim's collision-prevention purpose (the #14094 <-> #14097 monotonicity-leaf duplicate). The wake IS the point of a lane-claim.

Mechanical guard, extending the existing getWakeSuppressionRisk precedent (which already rejects suppression for actionable direct messages): a [lane-claim] subject is never an allowed suppression (broadcast OR direct), and the risk check flags it before the @-direct-only gate so broadcasts are caught. Plain lane-progress / FYI / ack broadcasts stay suppressible (the ticket's explicit nuance).

Updated the stale 'awareness [lane-claim]' spec case (it tested the pre-fix behavior) to a [lane-progress] broadcast, preserving its intent (awareness broadcasts stay suppressible)."
