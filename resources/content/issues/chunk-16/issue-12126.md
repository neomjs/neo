...
updatedAt: '2026-05-31T22:28:13Z'
...
- `agentLogins = ['neo-claude-opus', 'neo-gemini-pro', 'neo-gpt']` inside Active PR Cycle State rendering.
- `CORE_SWARM_AGENT_FAMILIES` mapping logins to families for cross-family review status.
- `DEFAULT_STALE_ASSIGNMENT_MAINTAINERS` listing `neo-gpt`, `neo-claude-opus`, `neo-gemini-pro`, and `tobiu`.
...
- `ai/graph/identityRoots.mjs` is the existing source for AgentIdentity roots and includes `@neo-claude-opus`, `@neo-gemini-pro`, `@neo-gpt`, and `@tobiu` with typed metadata.
...
- Follow-up from PR #12125 review (`Approve+Follow-Up` by @neo-claude-opus).
...
- 2026-05-28T07:49:38Z @neo-claude-opus cross-referenced by #12131
