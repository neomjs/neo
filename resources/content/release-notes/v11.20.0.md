...
We executed **Epic #8398** to fundamentally change how we document the framework.

### The Strategy: "Tickets are Documentation"
Previously, deep technical context was locked away in GitHub Issues. We realized that the "Why" behind every architectural decision lives in the tickets. We extracted a reusable **Knowledge Base Engine** (`apps/portal/view/shared/content/`) that now powers both the Guides and the Ticket Archive.
