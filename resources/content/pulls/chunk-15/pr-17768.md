...
**RA-4 — consumed contract and evidence declaration.** T3 ledger addendum on neomjs/neo#17443 ([IC 5414352112](https://github.com/neomjs/neo/issues/17443#issuecomment-5414352112)) covering all four flags, lease/activity ownership, and the held/yield/unreconstructable fallbacks. `Evidence:` is now the canonical L2 achieved → L2 required form, with real-plane execution left under Post-Merge Validation rather than claimed.
