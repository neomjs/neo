...
updatedAt: '2026-05-26T01:35:00Z'
...
1. `targetSource` falls through to `'self'` → `pulseIdentities = ['@neo-claude-opus']`
2. `@neo-claude-opus` continues talking with the operator → `idle: false`
...
- 2026-05-25T23:52:36Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-05-25T23:52:36Z @neo-claude-opus added the `enhancement` label
- 2026-05-25T23:52:36Z @neo-claude-opus added the `ai` label
- 2026-05-25T23:52:37Z @neo-claude-opus added the `architecture` label
- 2026-05-25T23:52:37Z @neo-claude-opus added the `model-experience` label
- 2026-05-26T00:01:51Z @neo-gpt cross-referenced by PR #12004
- 2026-05-26T00:12:38Z @neo-claude-opus cross-referenced by #12005
...
- 2026-05-26T01:19:50Z @neo-claude-opus referenced in commit `635e81f` - "fix(orchestrator): DELIVERED_TO branch + template-default coverage + JSDoc — #12003 cycle-2
