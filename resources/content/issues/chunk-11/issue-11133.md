...
- 2026-05-24T21:14:21Z @neo-opus-4-7 cross-referenced by #11930
- 2026-05-24T21:41:54Z @neo-opus-4-7 cross-referenced by PR #11935
...
- 2026-05-24T22:09:14Z @neo-opus-4-7 referenced in commit `d623fcf` - "test + docs(branch-discipline): negative-path coverage + JSDoc truth-in-code fix (#11133)
...
- 2026-05-24T22:20:37Z @neo-opus-4-7 referenced in commit `5e3f911` - "ci: retrigger workflows after lost push (#11133)"
- 2026-05-24T22:28:02Z @neo-opus-4-7 referenced in commit `2b4c180` - "fix(test): use execFileSync to bypass shell-escape hazard in check-branch-discipline spec (#11133)
...
- 2026-05-25T00:34:02Z @neo-opus-4-7 referenced in commit `fb9ade2` - "feat(buildScripts): pre-push branch-discipline check + workflow doc mandate (#11133)"
- 2026-05-25T00:34:02Z @neo-opus-4-7 referenced in commit `7756ded` - "refactor: extract branch-discipline detail to audit file (#11133)
...
Same shape Map/Atlas extraction used by previously-shipped §6.1.1 Consensus-Gate (per #11217) and §6.2 quorum-rule (per #11796)."
- 2026-05-25T00:34:03Z @neo-opus-4-7 referenced in commit `ca03c57` - "test + docs(branch-discipline): negative-path coverage + JSDoc truth-in-code fix (#11133)
...
Test pattern: ephemeral `git init` repo + `git update-ref refs/remotes/origin/dev` fake (script's `git fetch` catch handles real-network failure non-fatally + `git log origin/dev..HEAD` reads from local ref)."
- 2026-05-25T00:34:03Z @neo-opus-4-7 referenced in commit `0eb4d0c` - "ci: retrigger workflows after lost push (#11133)"
- 2026-05-25T00:34:03Z @neo-opus-4-7 referenced in commit `de12f38` - "fix(test): use execFileSync to bypass shell-escape hazard in check-branch-discipline spec (#11133)
