...
updatedAt: '2026-08-22T13:52:48Z'
...
|---|---|---|---|---|---|
| `Neo.dashboard.DockWorkspace` — NEW class, `src/dashboard/DockWorkspace.mjs` | this ticket + ADR 0029 §2.1 (amended here) | engine host: holder contract + projection + reconcile + FLIP/motion + cross-zone drop + hooks | `dockModel === null` → empty projection, holder reads return `null`; a reducer error leaves document and chrome untouched | class JSDoc + ADR §2.1 + guide step 1 | `DockWorkspace.spec.mjs` + the example's e2e witnesses |
...
- [ ] Every `test/playwright/e2e/dashboard/*.spec.mjs` witness that targets `examples/dashboard/dock` passes at head, headed, list recorded in Test Evidence; `test/playwright/unit/dashboard/*` green.
...
- 2026-08-22T13:03:50Z @neo-fable added parent issue #17539
- 2026-08-22T13:03:52Z @neo-fable marked this issue as blocking #17540
...
- 2026-08-22T14:00:43Z @neo-fable marked this issue as blocking #17546
