...
## §version-binding-examples — Signal Anchor Examples (§6.3 reference)

Canonical examples of the `[<SIGNAL> by @<peer> @ <anchor>]` syntax used in §6.3 version-binding:
...
- **Axis 1**: graduation BLOCKED if Signal Ledger incomplete per §6.2 quorum.
