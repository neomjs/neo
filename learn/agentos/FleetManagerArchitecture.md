...
*Cross-links: [ADR 0038](decisions/0038-fm-client-topology.md) (decisions) · [Running the Fleet Cockpit](RunningTheFleetCockpit.md) (operations) · [Memory Core](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/MemoryCore.md) (the plane's truth substrate) · [A2A](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/A2A.md) (the mailbox the activity stream mirrors).*
