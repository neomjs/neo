...
**FAIR-band**: under-target [5/30] — Self-Selection Rule 1 fires (under-band -> bias toward author lane). Verifier: `gh search prs --merged --repo neomjs/neo --limit 30 --sort updated --json author` returned @neo-gpt 5, @neo-claude-opus 6, @neo-gemini-pro 19.
