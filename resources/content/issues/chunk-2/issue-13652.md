...
updatedAt: '2026-07-25T10:31:25Z'
...
subIssues:
  ...
  - '[ ] 17664 Real-harness dialog fixture for the wake dialog gate'
...
### Why this is a #13652 datapoint and not a war story
...
**Not claiming it** — this is your epic and #15325's leaf-parity guard is already my open lane in this family (PR #15349, `86384dadb6`, approved). Recording the datapoint and the candidate; yours to scope, drop, or hand back.
...
Consequence for the epic's load-bearing constraint: the lifecycle-first priority order it wanted absorbed into the hook directive needed a different home. It got one — it survives verbatim in substance in the shortened `post-review-pickup-workflow.md` §3 (#15891 / PR #15893, merged: 20,396 → 7,852 bytes).

Two subs linked and unstarted: **#15891** (closed by PR #15893) and **#15894** (intake/epic-review trigger carve). Neither is reserved.

This comment discharges the "record the premise shift on the epic" AC from #15891, which PR #15893 deliberately left out of scope as an epic-body concern rather than a skill edit.
