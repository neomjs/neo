...
updatedAt: '2026-08-13T14:04:29Z'
...
- [ ] Adding or moving one path produces only the required topology mutations; unchanged siblings stay untouched.
- [ ] Existing intentional `linkNodes()` reinforcement remains covered and unchanged.
- [ ] Filesystem-sync receipts distinguish created/updated topology from merely verified topology.
