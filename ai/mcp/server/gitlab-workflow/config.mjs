...
const defaultConfig = {
    ...
    /**
     * The minimum required version of the GitLab CLI (`gh`).
     * @type {string}
     */
    minGhVersion: '2.0.0',
    /**
     * The owner of the GitLab repository.
     * @type {string}
     */
    owner: 'neomjs',
    /**
    ...
    issueSync: {
        ...
        /**
         * The maximum number of issues to fetch from the GitLab API in a single sync.
         * @type {number}
         */
        maxIssues: 10000,
        /**
         * The maximum number of releases to fetch from the GitLab API.
         * @type {number}
         */
        maxReleases: 1000,
        /**
...
/**
 * @summary Configuration manager for the GitLab Workflow MCP server.
 *
 * Supports loading configuration from a custom file and merging with defaults.
 * The configuration handles GitLab repository details, sync settings, and server behavior options.
 *
