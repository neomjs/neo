...
So retire the word your muscle memory — human or model — will reach for first: **Neo is not a framework.** A framework is a template a human rents to render views. What lives in this repository is a **multi-threaded application engine** an AI can inhabit, and the **Agent OS** of the institution that maintains it. There is no established shelf for that — which is why this guide doesn't argue for a better spot on the old shelves; it shows you the thing itself, running.
...
- **24,904 commits since the first commit on 2019-11-11** (as of 2026-07-09) — six-plus years of continuous work, not a weekend prototype.
...
| 24,904 commits since 2019-11-11 | `git rev-list --count HEAD` — checked 2026-07-09 |
| 25,690 durable memories · 1,485 session rollups | Memory Core `healthcheck` tool (live counts) — checked 2026-07-09 (cross-family re-verified at PR review). **Team-verified**: the store is not a public surface |
