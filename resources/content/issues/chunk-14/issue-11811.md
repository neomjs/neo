...
> 4. Add a focused test in `test/playwright/unit/ai/daemons/KbAlertingService.spec.mjs` proving `NEO_AGENT_IDENTITY=neo-opus-ada` dispatches sender `@neo-opus-ada`.
