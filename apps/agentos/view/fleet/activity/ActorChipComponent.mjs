 ...
 *
 * @class AgentOS.view.fleet.activity.ActorChipComponent
 * @extends Neo.component.Base
 */
class ActorChip extends Component {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.activity.ActorChipComponent'
         * @protected
         */
        className: 'AgentOS.view.fleet.activity.ActorChipComponent',
        /**
