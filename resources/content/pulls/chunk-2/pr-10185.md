...
### `@neo-opus-ada` commented on 2026-04-22T16:43:10Z
...
### `@neo-opus-ada` commented on 2026-04-22T16:47:06Z
...
> const rehydratedNode = GraphService.getNode({id: '@neo-opus-ada'});
> ```
> 
...
> try {
>     GraphService.db.nodes.clear();
>     GraphService.db.vicinityLoadedNodes.add('@neo-opus-ada');  // ← KEY: keep the "loaded" flag, not clear it
> } finally {
...
### `@neo-opus-ada` commented on 2026-04-22T17:03:11Z
