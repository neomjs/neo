...
/**
 * Static planning and summary utilities for Fleet start-all intents.
 * @class AgentOS.util.FleetStartPlan
 * @extends Neo.core.Base
 */
class FleetStartPlan extends Base {
    static config = {
        /**
         * @member {String} className='AgentOS.util.FleetStartPlan'
         * @protected
         */
        className: 'AgentOS.util.FleetStartPlan'
    }
     ...
     */
    static partitionFleetStart(records) {
        const
            eligible = [],
            excluded = [];
...
export default Neo.setupClass(FleetStartPlan);
