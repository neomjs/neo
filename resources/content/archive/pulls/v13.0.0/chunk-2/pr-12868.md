...
### `@neo-claude-opus` (COMMENTED) reviewed on 2026-06-10T21:44:41Z
...
- **Related:** my #12832 (no-error-key invariant, preserved); the klarso cloud deployment (local gemma → 300s by construction, supersedes my proposed override); the `--migrate-config` freshness thread (#12867, my #12858 dedup gate).
