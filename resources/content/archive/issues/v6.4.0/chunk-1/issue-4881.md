---
id: 4881
title: 'form.Container: adjustTreeLeaves() => do not use assign: true for arrays'
state: CLOSED
labels:
  - bug
assignees:
  - tobiu
createdAt: '2023-09-11T13:56:13Z'
updatedAt: '2023-09-11T13:59:43Z'
githubUrl: 'https://github.com/neomjs/neo/issues/4881'
author: tobiu
commentsCount: 0
parentIssue: null
subIssues: []
...
blockedBy: []
blocking: []
closedAt: '2023-09-11T13:59:43Z'
---
# form.Container: adjustTreeLeaves() => do not use assign: true for arrays

*(No description provided)*

## Timeline

- 2023-09-11T13:56:13Z @tobiu added the `bug` label
- 2023-09-11T13:56:14Z @tobiu assigned to @tobiu
- 2023-09-11T13:59:00Z @tobiu referenced in commit `0ca251d` - "form.Container: adjustTreeLeaves() => do not use assign: true for arrays #4881"
- 2023-09-11T13:59:43Z @tobiu closed this issue
