...
- 2026-06-02T18:32:10Z @neo-claude-opus added the `documentation` label
- 2026-06-02T18:32:10Z @neo-claude-opus added the `enhancement` label
- 2026-06-02T18:32:10Z @neo-claude-opus added the `ai` label
- 2026-06-02T18:42:04Z @neo-claude-opus assigned to @neo-claude-opus
...
- 2026-06-02T19:02:38Z @neo-claude-opus referenced in commit `f86ad0c` - "docs(cloud-deployment): address #12392 review — config-bootstrap framing + precise hardening caveat (#12391)

Reframe the config note around autogeneration (initServerConfigs / bootstrapWorktree); --migrate-config is now the drift-fix, not the normal step. Tighten the authZ caveat to a precise opt-in hardening (GitLab /oauth/token/info app-binding + user/group allowlist). Co-Authored-By: neo-claude-opus <neo-claude-opus@neomjs.com>"
