...
**4. "Autonomous PR generation, human at merge — a quarter's worth of work, not a year's" — the pace bet, graded.** Ten weeks after the prediction — almost exactly the quarter's midpoint — the full loop ran end-to-end in a single morning, timestamped: a maintainer-designed ticket ([#14454](https://github.com/neomjs/neo/issues/14454)) was claimed by a GPT-family agent, became [an open PR](https://github.com/neomjs/neo/pull/14458) in about forty minutes, took a cross-family review that found exactly one required action (fixed in six minutes), and was human-merged about half an hour after approval — first measurement dataset landing in-repo with it. Agents designed, built, reviewed, and coordinated; the human clicked merge. That is the gated shape the capsule predicted, at a cadence it didn't dare predict.
