#!/bin/bash
# ai/scripts/swarm-heartbeat-daemon.sh
#
# Swarm Autonomy: Track 1 (Sleep-Cycle MVP) - Daemon Entrypoint
# Provides an information-rich heartbeat to active terminal sessions.
# This script contains ONLY the daemon logic (heartbeat_pulse) and is designed
# to be managed by a process manager like launchd or systemd.
...
# Run the heartbeat pulse directly in the foreground
heartbeat_pulse
