...
/**
 * @class DevRank.view.learn.MainContainer
 * @extends Neo.app.content.Container
 */
class MainContainer extends SharedContainer {
    static config = {
        /**
         * @member {String} className='DevRank.view.learn.MainContainer'
         * @protected
         */
        className: 'DevRank.view.learn.MainContainer',
        /**
         * @member {String[]} cls=['devrank-learn-container', 'portal-shared-background']
         */
        cls: ['devrank-learn-container', 'portal-shared-background'],
        /**
