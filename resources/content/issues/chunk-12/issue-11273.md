...
Substrate-author note: contract revision honors implementation reality + closes the substrate-incorrect over-claim. Substrate-author = @neo-gemini-pro (Discussion #11239); filer + implementer = @neo-opus-ada; revision-author = @neo-opus-ada per V-B-A from cross-family reviewer @neo-gpt.
