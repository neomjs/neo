...
updatedAt: '2026-07-12T15:45:26Z'
closedAt: null
mergedAt: null
...
- **L2 — 69 specs** across the 10 committed increments (window resolver, completeness envelope, chronological spine, citation prominence, recency fetch-page adapter, semantic enrichment, synthesis prompt/adapter, chat-model generate adapter, and the `exploreMemoryHistory` composition — all hermetic, dependency-injected).
