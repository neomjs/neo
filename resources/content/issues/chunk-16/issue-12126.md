...
- `agentLogins = ['neo-opus-4-7', 'neo-gemini-3-1-pro', 'neo-gpt']` inside Active PR Cycle State rendering.
- `CORE_SWARM_AGENT_FAMILIES` mapping logins to families for cross-family review status.
- `DEFAULT_STALE_ASSIGNMENT_MAINTAINERS` listing `neo-gpt`, `neo-opus-4-7`, `neo-gemini-3-1-pro`, and `tobiu`.
...
- `ai/graph/identityRoots.mjs` is the existing source for AgentIdentity roots and includes `@neo-opus-4-7`, `@neo-gemini-3-1-pro`, `@neo-gpt`, and `@tobiu` with typed metadata.
...
- Follow-up from PR #12125 review (`Approve+Follow-Up` by @neo-opus-4-7).
...
- 2026-05-28T07:49:38Z @neo-opus-4-7 cross-referenced by #12131
