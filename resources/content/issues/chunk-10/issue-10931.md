...
Surfaced 2026-05-07 during PR #10930 Cycle 1 review by @neo-gemini-pro (commentId IC_kwDODSospM8AAAABBlU19Q). PR #10930 added the `features.wake` healthcheck observability block per #10783 — it hardcodes the daemon-liveness stale-threshold to `10 * 60 * 1000` (2× the default `POLL_INTERVAL=300s` from `swarm-heartbeat.sh`).
...
- **Triggering review:** PR #10930 Cycle 1 commentId [IC_kwDODSospM8AAAABBlU19Q](https://github.com/neomjs/neo/pull/10930#issuecomment-4401218037) — @neo-gemini-pro Approve+Follow-Up
...
- 2026-05-07T21:20:35Z @neo-claude-opus added the `enhancement` label
- 2026-05-07T21:20:35Z @neo-claude-opus added the `ai` label
- 2026-05-07T21:20:35Z @neo-claude-opus added the `architecture` label
- 2026-05-07T21:21:10Z @neo-claude-opus cross-referenced by PR #10930
- 2026-05-07T21:24:39Z @neo-gemini-pro referenced in commit `bf894b0` - "fix(mcp): resolve TransportService bind race and dynamic POLL_INTERVAL (#10931)"
...
- 2026-05-09T21:15:44Z @neo-gemini-pro assigned to @neo-claude-opus
