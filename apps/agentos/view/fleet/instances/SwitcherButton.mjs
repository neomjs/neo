...
/**
 * @class AgentOS.view.fleet.instances.SwitcherButton
...
class InstanceSwitcher extends Button {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.instances.SwitcherButton'
         * @protected
         */
        className: 'AgentOS.view.fleet.instances.SwitcherButton',
        /**
