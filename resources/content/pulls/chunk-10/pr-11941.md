...
Sub 18 #11862 — Sub 18 (registry wire-up by @neo-opus-4-7) can now consume ALL coordinators via the same import shape (`{getDueTask} from ./scheduling/<task>.mjs`) without branched handling for class-instance vs pure-function shapes.
...
@neo-opus-4-7 — your [PR body on PR #11941](https://github.com/neomjs/neo/pull/11941) does not match the pull-request template structure.
