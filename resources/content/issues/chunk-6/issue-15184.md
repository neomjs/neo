...
updatedAt: '2026-08-24T11:51:52Z'
...
|---|---|---|---|---|
| Canonical server transport vocabulary + fail-closed dispatch | #15188 | [#15191](https://github.com/neomjs/neo/pull/15191) | Exact head `5cad6a0c` received cross-family approval and merged into `dev` as [`d839f644`](https://github.com/neomjs/neo/commit/d839f644ae45da8cce904488c5691076110582fa); #15188 closed `COMPLETED` | None for this row |

Live graph after the merge:

- #15185 is open, unassigned, and its only recorded prerequisite (#15188) is closed.
- #15186 is open, unassigned, and independent.
- #15187 remains blocked by #15185 and #15186; the external readiness receipt is already accepted.
...
| Parent outcome | Owning sub | Delivered PR | Achieved evidence | Residual state |
|---|---|---|---|---|
| Literal loopback bind + independent Origin, Host, and bearer guards | #15185 | [#15214](https://github.com/neomjs/neo/pull/15214) | Exact head `61f1d23e` received cross-family approval and merged into `dev` as [`84e50916`](https://github.com/neomjs/neo/commit/84e5091602def31943b7f3c3c560afe88fbcc56b); #15185 closed `COMPLETED` | None for this row |

Live graph after the merge:

- #15186 is implemented in [#15224](https://github.com/neomjs/neo/pull/15224); review routing waits for exact-head CI to finish.
- #15187 now has one unresolved native prerequisite: #15186.
...
| Parent outcome | Required evidence | Owning sub(s) | Delivered PR(s) | Achieved evidence | Residual state |
|---|---|---|---|---|---|
| Canonical server transport vocabulary + fail-closed dispatch | L2 | #15188 | #15191 | L3 — real Dockerized KB/MC Streamable HTTP plus exact-value migration and fail-loud old/unknown values | none — closed |
| Literal loopback bind + independent Origin, Host, and bearer guards | L3 | #15185 | #15214 | L3 — real loopback socket, authenticated MCP initialize, and independent rejection probes | none — closed |
| Exact OpenAPI-owned three-operation list/call projection | L2 | #15186 | #15224 | L2 — real OpenAPI compiler with list/call enforcement and constrained-input falsifiers | none — closed |
| Blind BigData receipt + complete temporary diagnostic-root erasure | L4 | #15187 | — | L0 — external readiness accepted and both native prerequisites closed, but the journey/oracle/deletion receipt has not run | BLOCKER — implementation not started; leaf is ready and unblocked |
...
|---|---|---|---|---|---|
| OQ1 exact projection authority | Exact projection row | #15186 | #15224 | L2 | none — delivered |
| OQ2 disposable bearer | Loopback/bearer row | #15185 | #15214 | L3 | none — delivered |
| OQ3 listener security | Loopback/bearer row | #15185 | #15214 | L3 | none — delivered |
| OQ4 blind salted oracle | BigData journey row | #15187 | — | L0 | BLOCKER — pending journey |
| OQ5 diagnostics isolation and deletion | BigData journey row | #15187 | — | L0 | BLOCKER — pending journey |
| OQ6 client readiness receipt | BigData prerequisite | #15187 | external receipt | Public commit/version/command/full-suite receipt accepted in D#15173 | none — prerequisite delivered |
| OQ7 contribution path and Neo review authority | Epic/leaf ownership contract | #15185, #15186, #15187 | #15214, #15224 | L1 — native graph and ticket boundaries match the approved contract | none — delivered |
| Pilot leaf 1: local ingress/security | Loopback/bearer row | #15185 | #15214 | L3 | none — delivered |
| Pilot leaf 2: exact projection | Exact projection row | #15186 | #15224 | L2 | none — delivered |
| Pilot leaf 3: BigData oracle/retention receipt | BigData journey row | #15187 | — | L0 | BLOCKER — pending journey |
...
| Standard Streamable HTTP; no legacy HTTP+SSE | Vocabulary + ingress outcomes | #15188, #15185 | #15191, #15214 | L3 | none — delivered |
| Complete local threat model | Ingress + projection + deletion outcomes | #15185, #15186, #15187 | #15214, #15224 | L3/L2/L0 | BLOCKER — diagnostic deletion leg pending |
| Exact oracle and success/failure receipt | BigData journey row | #15187 | — | L0 | BLOCKER — pending journey |
| Reuse of #13056 rather than duplicate ownership | Exact projection row | #15186 | #15224 | L2 — OpenAPI/ToolService authority extended in place | none — delivered |
| Complete leaf set, ordering, evidence gates, and self-selection | Native issue graph | #15185–#15188 | #15191, #15214, #15224 | Three of four leaves closed; final leaf ready | none — mapping delivered; execution remains above |
...
| Decision Record, dissent, liveness, and criteria mapping | Epic mechanics | #15184 | — | Required sections present and current | none — delivered |

### Rationale

Three of the four native outcomes are delivered at or above their required evidence levels. #15188, #15185, and #15186 are closed by merged PRs; the public Genesis readiness receipt is accepted. The live graph now leaves exactly one unfinished outcome: #15187's L4 BigData journey, blind oracle reproduction, joint receipt, and complete diagnostics-root erasure.

This is not a missing-sub or supersession case. #15187 already owns every remaining source criterion, and it is now ready: both native prerequisites are closed and the external prerequisite is satisfied. Closing #15184 now would silently discard the Discussion's oracle, honest-not-inferable result, and two-sink deletion promises.

### Required operator action

Keep the Epic open while #15187 executes. No new sub or operator authorization is required; the existing leaf is self-selection-ready.

### A2A coordination

The #15187 lane is claimed by @neo-gpt after a `valid-as-written` intake. Broadcast receipt: `MESSAGE:0ecc6cb1-f163-4833-82bb-ca06546d49e2`; intake anchor: `IC_kwDODSospM8AAAABKW8NcQ`.
...
- 2026-07-16T17:57:12Z @neo-gpt added sub-issue #15291
...
| Parent outcome | Required evidence | Owning sub(s) | Delivered PR(s) | Achieved evidence | Residual state |
|---|---|---|---|---|---|
| Canonical `streamable-http` server vocabulary + fail-closed dispatch | L2 | #15188 | PR #15191 | L3 — real container transport plus exact-value migration/fail-loud legacy values | none — closed |
| Literal loopback bind + independent Origin, Host, disposable-bearer guards | L3 | #15185 | PR #15214 | L3 — real socket/MCP initialize and independent rejection probes | none — closed |
| Exact OpenAPI-owned three-operation projection | L2 | #15186 | PR #15224 | L2 — production OpenAPI compiler/list/call enforcement + constrained-input falsifiers | none — closed |
| Reusable blind BigData runner, local oracle, and diagnostic-root erasure | L3 | #15187 | PR #15279 | L3 — bundled-Chromium exact-profile run, 3/3 calls, matched commitment/reveal, process/listener cleanup, whole-root erasure | none — closed; external receipt explicitly split |
| Real synchronized Genesis bilateral receipt | L4 | #15291 | none — execution-only | L3 local rehearsals only; no current Genesis artifact re-anchor, confirmed window, frozen external deliverable, bilateral hash, or joint cleanup receipt | BLOCKER |

### Source Discussion Closeout Gate

| D#15173 criterion family | Epic outcome / owner | Achieved evidence | Residual |
|---|---|---|---|
| OQ1–OQ3: standard Streamable HTTP, exact projection, local bearer/listener threat model | #15188, #15185, #15186 | L3/L2 delivered by PRs #15191/#15214/#15224 | none |
| OQ4/OQ5 implementation: salted oracle + two-sink isolated diagnostics/deletion | #15187 | L3 reusable runner + exact-head Neo rehearsal in PR #15279 | none for implementation |
| OQ4/OQ5 bilateral success: commitment before external freeze, reveal/hash reproduction, joint review/cleanup | #15291 | L0 external bilateral receipt; latest public state is expired windows + requested Genesis v7.9.45 re-anchor | BLOCKER |
...
| OQ7 collaboration/ownership + leaf ordering | Epic/native graph | Implementation leaves delivered; #15291 remains assigned to @neo-gpt as execution owner | none — mapping preserved |
| STEP_BACK, family-keyed quorum, Decision Record/dissent/liveness mechanics | D#15173 / Epic #15184 | Recorded at the approved body anchor | none |

No source criterion is lost. Every unmet bilateral criterion is explicitly owned by #15291.

### Rationale

The 2026-07-16 closeout correctly kept the Epic open while #15187 was pending. That implementation has since shipped: PR #15279 delivers the runner and a real local L3 rehearsal, and its body explicitly names #15291 as the required Epic successor rather than promoting the local rehearsal into bilateral proof.

#15291 remains genuinely open, not administratively stale-complete. Its last state records two expired scheduling windows, Genesis version drift from the accepted 7.9.38 artifact to proposed 7.9.45, a requested artifact re-anchor, and no later external reply. The public thread contains no bilateral frozen deliverable, hash agreement, or joint cleanup authorization. Closing the parent would drop the source Discussion's defining collaboration receipt.

For Epic #17500's D1 list, #15184 and #15291 are not two blockers. The parent has exactly one unfinished outcome, already represented by #15291. **Remove #15184 from the must-resolve count; retain #15291 as the concrete pre-cut gate.** This is de-duplication, not a waiver of the external receipt.

### Required operator action

Keep #15184 open. No new sub is needed. Before #15291 reactivation, its assigned owner should re-run ticket-intake against current `dev`, obtain a fresh Genesis artifact/availability response, and schedule one secret-safe window; no prior window or private channel is assumed current.
...
- @neo-gpt — #15291 owner;
- @neo-opus-vega — prior environment/re-anchor coordinator and Epic #17500 split coordinator.
