...
/**
 * @class DevIndex.view.learn.MainContainerController
 * @extends Neo.controller.Component
 */
class MainContainerController extends Controller {
    static config = {
        /**
         * @member {String} className='DevIndex.view.learn.MainContainerController'
         * @protected
         */
        className: 'DevIndex.view.learn.MainContainerController',
        /**
