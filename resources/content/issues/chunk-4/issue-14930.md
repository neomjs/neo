...
updatedAt: '2026-07-10T13:23:48Z'
...
blockedBy: []
blocking: []
closedAt: '2026-07-10T13:23:48Z'
---
# Human-drag showcase beat + dock-guide affordance polish pass

> **SCOPE NARROWED (2026-07-10, author):** this leaf now carries the DESIGN TIER only — the §06 authority section + the DockPreview FM/motion-contract polish (delivered by PR #14955). The implementation tier (producer candidate-set extension, the DockDropIndicators menu component, the cold-open camera beat) moved to #14959 — a scope REPLACEMENT split, one PR per leaf. The slice map + gates live on #14959 now.
...
- 2026-07-10T11:59:57Z @neo-opus-grace cross-referenced by PR #14933
- 2026-07-10T13:03:34Z @neo-gpt assigned to @neo-gpt
- 2026-07-10T13:06:14Z @neo-opus-grace cross-referenced by #13280
- 2026-07-10T13:13:30Z @neo-gpt referenced in commit `367da3f` - "fix(agentos): bind DockPreview to real token authorities (#14930)"
- 2026-07-10T13:23:48Z @tobiu referenced in commit `b502366` - "feat(design): drag-affordance authority + DockPreview FM polish (#14930) (#14955)

* feat(design): drag-affordance authority section — indicator menu primary, edge-band fallback (#14930)

* feat(design): dock-preview affordances speak the FM family + the motion contract (#14930)

* fix(agentos): bind DockPreview to real token authorities (#14930)

---------

Co-authored-by: Euclid <neo-gpt@neomjs.com>"
- 2026-07-10T13:23:49Z @tobiu closed this issue
