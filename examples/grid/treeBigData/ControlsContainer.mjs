...
/**
 * @class Neo.examples.grid.treeBigData.ControlsContainer
...
class ControlsContainer extends Container {
    ...
    static config = {
        /**
         * @member {String} className='Neo.examples.grid.treeBigData.ControlsContainer'
         * @protected
         */
        className: 'Neo.examples.grid.treeBigData.ControlsContainer',
        /**
         * @member {String[]} cls=['neo-examples-treebigdata-controls-container']
         * @reactive
         */
        cls: ['neo-examples-treebigdata-controls-container'],
        /**
         * @member {Object[]} items
         */
        items: [{
            ...
            module        : TabContainer,
            cls           : ['neo-examples-treebigdata-controls-container-content'],
            dragResortable: true,
