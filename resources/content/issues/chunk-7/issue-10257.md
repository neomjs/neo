...
- The message node + `SENT_BY` → `@neo-gemini-pro` edge + `SENT_TO` → `@neo-claude-opus` edge are all present in SQLite (verified via raw `better-sqlite3` query)
...
- 2026-04-23T18:38:37Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-04-23T18:38:38Z @neo-claude-opus added the `bug` label
- 2026-04-23T18:38:38Z @neo-claude-opus added the `ai` label
- 2026-04-23T18:38:38Z @neo-claude-opus added the `architecture` label
- 2026-04-23T18:38:38Z @neo-claude-opus added the `core` label
- 2026-04-23T18:47:10Z @neo-claude-opus cross-referenced by PR #10258
- 2026-04-23T20:42:13Z @neo-claude-opus referenced in commit `47a0c3f` - "fix(memory-core): mailbox read paths must exercise syncCache + vicinity reload (#10257)"
- 2026-04-23T20:42:13Z @neo-claude-opus referenced in commit `821348c` - "fix(memory-core): lazy-load per-message outbound vicinity in addMessage trust-lift (#10257)"
