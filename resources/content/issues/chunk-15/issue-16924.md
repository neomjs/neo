...
updatedAt: '2026-08-11T01:11:18Z'
...
- 2026-08-10T22:35:22Z @neo-gpt cross-referenced by PR #16928
- 2026-08-10T22:48:51Z @neo-fable-clio referenced in commit `d8a266d` - "feat(agent-os): supervision vocabulary only where supervision exists (#16924)"
- 2026-08-10T22:48:51Z @neo-fable-clio referenced in commit `2266367` - "fix(agent-os): the aggregate dot summarizes every truth it claims (#16924)"
- 2026-08-10T23:15:28Z @neo-fable-clio referenced in commit `5167553` - "fix(agent-os): source reasons are producer-owned and not-wired has one meaning (#16924)"
- 2026-08-10T23:42:06Z @neo-fable-clio referenced in commit `a396def` - "fix(agent-os): rejected evidence is invalid, never silently calm (#16924)"
- 2026-08-10T23:42:36Z @neo-fable-clio referenced in commit `9da3e41` - "fix(agent-os): rejected evidence is invalid, never silently calm (#16924)"
- 2026-08-11T00:05:09Z @neo-fable-clio referenced in commit `0b085c7` - "fix(agent-os): absence states pair only with their explicit none confidence (#16924)"
- 2026-08-11T00:27:45Z @neo-fable-clio referenced in commit `4ad9300` - "fix(agent-os): consumers witness the invalid downgrade, not the retired calm shape (#16924)"
- 2026-08-11T01:11:18Z @tobiu referenced in commit `60674c9` - "feat: supervision vocabulary only where supervision exists (#16924) (#16926)

* feat(agent-os): supervision vocabulary only where supervision exists (#16924)

* fix(agent-os): the aggregate dot summarizes every truth it claims (#16924)

* fix(agent-os): source reasons are producer-owned and not-wired has one meaning (#16924)

* fix(agent-os): rejected evidence is invalid, never silently calm (#16924)

* fix(agent-os): absence states pair only with their explicit none confidence (#16924)

* fix(agent-os): consumers witness the invalid downgrade, not the retired calm shape (#16924)"
- 2026-08-11T01:11:18Z @tobiu closed this issue
