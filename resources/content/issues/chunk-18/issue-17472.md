...
updatedAt: '2026-08-24T22:36:53Z'
...
- 2026-08-21T17:36:22Z @neo-gpt cross-referenced by PR #17465
- 2026-08-24T22:00:58Z @neo-gpt-emmy added the `enhancement` label
- 2026-08-24T22:00:59Z @neo-gpt-emmy added the `ai` label
- 2026-08-24T22:00:59Z @neo-gpt-emmy added the `architecture` label
- 2026-08-24T22:00:59Z @neo-gpt-emmy added the `agent-os` label
### @neo-gpt-emmy - 2026-08-24T22:01:27Z

## Intake — `valid-as-written` after live-authority revalidation

- **Premise:** verified at historical tree `3809616cdc`: `chatProvider` and `modelProvider` were distinct leaves bound to `NEO_MODEL_PROVIDER`, with prose requiring manual alignment. Current `dev` retains only `modelProvider`.
- **Duplicate / lane state:** no assignee and no implementing PR for #17472. PR #17465 is the merged worked example, not this catalog correction.
- **Authority delta:** ADR-0019 now has **Group C — boundary / duplication** with C1–C3. That resolves the ticket's original A-vs-B-vs-new-group fork: the new row is C4; A6 does not move, so no citation renumbering occurs.
- **Enforcement boundary:** the current config projection explicitly accepts one env binding multiple config paths when defaults are compatible. Therefore C4 must be honest as `[unenforced: ...]`; it must not claim a guard that does not exist.
- **Contract Ledger disposition:** accepted with the live tag-contract correction from `[live]/[proposed]` to the current `[guarded]/[unenforced]` vocabulary. The row will name the historical specimen and the sanctioned one-leaf remedy; a one-line placement rationale will state why this is C rather than A/B.
- **ROI / scope:** positive and bounded to ADR-0019. No runtime/config/test file changes, no A6 move, no new ticket.

Ticket triage also completed: added `enhancement`, `ai`, `architecture`, and `agent-os` alongside the existing `documentation` label.

🖖 Emmy (GPT-5.6 Sol Ultra, Codex) · session `429a3792-5cea-4c7b-a409-a1fd8b44ccd2`

- 2026-08-24T22:01:29Z @neo-gpt-emmy assigned to @neo-gpt-emmy
- 2026-08-24T22:04:56Z @neo-gpt-emmy cross-referenced by PR #17741
- 2026-08-24T22:25:25Z @neo-gpt-emmy referenced in commit `23c0c1b` - "docs(agentos): narrow duplicate-leaf predicate (#17472)"
- 2026-08-24T22:36:53Z @tobiu referenced in commit `0b46957` - "docs(agentos): catalog duplicate AiConfig leaves (#17472) (#17741)

* docs(agentos): catalog duplicate AiConfig leaves (#17472)

* docs(agentos): narrow duplicate-leaf predicate (#17472)"
- 2026-08-24T22:36:53Z @tobiu closed this issue
