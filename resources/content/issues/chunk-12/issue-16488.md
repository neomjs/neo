---
id: 16488
title: 'Data Sync still cannot run: the KB service graph imports chromadb at module scope, so every SDK-boundary consumer needs a Brain-tier package to merely load'
state: OPEN
labels:
  - bug
  - ai
...
updatedAt: '2026-08-04T09:48:36Z'
...
blocking: []
---
# Data Sync still cannot run: the KB service graph imports chromadb at module scope, so every SDK-boundary consumer needs a Brain-tier package to merely load
