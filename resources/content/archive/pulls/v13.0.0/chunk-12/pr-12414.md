...
- [x] Implemented PR diff matches those ACs for the code/docs slice: registry remap to osascript, `@neo-opus-grace` mapping, test coverage update, doc reference update, and post-merge live validation residual.
