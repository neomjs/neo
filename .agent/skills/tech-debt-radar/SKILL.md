...
If you need to sweep for ambient architectural debt, analyze historical epics, or mine the Memory Core for abandoned code flows, you MUST immediately use the `view_file` tool to read and strictly adhere to `/Users/Shared/github/neomjs/neo/.agent/skills/tech-debt-radar/references/tech-debt-radar-guide.md` before proceeding.
