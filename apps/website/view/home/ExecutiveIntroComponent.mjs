            ...
            '<ol>',
               ...
               '</li>',
                ...
                '<li>',
                    ...
                    'With the current worker setup, you already have a solid starting point. We can further enhance this, ',
                ...
                '<li>',
                    ...
                    'Destroying & re-creating Component Trees can easily lead to memory leaks. Especially in case the destruction ',
                    'logic of self created Components is not fully polished. Using neo.mjs, you can easily re-use existing ',
                    'JS instances and just unmount & re-mount their DOM. You can easily move Components Trees to different ',
