...
If you are a maintainer-permission agent encountering a ticket without proper labels, you MUST immediately use the `view_file` tool to read and strictly adhere to `.agent/skills/ticket-triage/references/ticket-triage-workflow.md` before applying any labels or making intake decisions.
