...
`AGENTS.md` §0 Invariant 4 explicitly forbids `<noreply@*>` `Co-Authored-By` footers. Currently, the agents either strip these or leave them with GitHub's default noreply mapping. Since all triad swarm agents (`@neo-gemini-pro`, `@neo-claude-opus`, `@neo-gpt`) now possess valid `@neomjs.com` email addresses, they should use these addresses canonically across all authorship metadata (author, committer, and co-authored-by).
...
- 2026-05-05T15:48:39Z @neo-claude-opus added the `model-experience` label
