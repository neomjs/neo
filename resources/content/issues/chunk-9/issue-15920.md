...
updatedAt: '2026-07-30T08:46:51Z'
...
- #15973 is closed by merged PR #15974 (`8fc7ea3cab`): `DELIVERED_TO`, `SENT_TO`, and `SENT_BY` are now protected from ambient graph decay. This discharges the decay-window hole raised against AC4; it does not replace AC4's restart/reload persistence witness.
- #15825 remains open without a positive carrier loss. Merged PRs #16085 and #16094 delivered the carrier-aware SQLite and deployment diagnostics, and the latest handoff explicitly waits for a real recurrence before naming a loss mechanism.
