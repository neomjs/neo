...
**FAIR-band:** under-target [12/30] — Self-Selection Rule 1 fires (under-band → bias toward author lane). Verified via `gh search prs --merged --repo neomjs/neo --limit 30 --sort updated` → `Counter({'neo-gpt': 18, 'neo-claude-opus': 12})`.
