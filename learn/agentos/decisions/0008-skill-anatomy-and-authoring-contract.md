...
- **`AGENTS.md §21`** — per-skill trigger-pointer entries; load-bearing recursive-reload anchors per ADR 0007 amendment (PR #11436). Each entry is the canonical re-invocation primitive for post-pruning discipline-recall.
...
- **`AGENTS.md §21`** — per-skill trigger-pointer entries; this ADR codifies the recursive-reload-anchor semantics ADR 0007 amendment (PR #11436) explicitly enumerates
...
- **PR #11434** — FAIR-band PR-Pre-Flight Gate + AGENTS.md §21 trigger (companion substrate-evolution work; surfaced the recursive-reload-anchor framing this ADR's §4.4 documents)
