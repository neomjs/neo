...
updatedAt: '2026-08-14T12:18:54Z'
closedAt: null
mergedAt: null
...
- `npm run test-unit -- test/playwright/unit/ai/services/fleet/` → 596 passed (cycle-5 head; was 550 (regression over the modified `fleetServer.mjs` included; `fleetServer.spec.mjs` green; includes the held-stream cap falsifiers added with the CodeQL repair — per-viewer cap with untouched-response proof + slot-freeing close, total cap across identities).
