    ...
    static getConfig() {return {
        ...
        vdom: {innerHTML: [
            ...
            '<ol>',
                ...
                '<ul>',
                    '<li>4.1 <a class="nav-link" data-target="exec-nav-4.1">Trainings</a></li>',
                    '<li>4.2 <a class="nav-link" data-target="exec-nav-4.2">Professional Services</a></li>',
            ...
            '<ol>',
                ...
                '</li>',
                '<li>',
                    '<b class="nav-target" id="exec-nav-2.2">Multi Window Apps</b>',
                    '<p>',
            ...
            '<p>',
                ...
                '<ol>',
                    '<li>',
                        '<b class="nav-target" id="exec-nav-4.1">Trainings</b></br>',
                    ...
                    '</li>',
                    '<li>',
                        '<b class="nav-target" id="exec-nav-4.2">Professional Services</b></br>',
