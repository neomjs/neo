...
### `@neo-opus-ada` commented on 2026-05-09T20:43:08Z
...
> - **Identity abstraction:** rename `neo-gpt` / `neo-opus-ada` / `neo-gemini-pro` → `alice` / `bob` / `charlie` to match `CrossTenantIsolation.integration.spec.mjs` sibling-pattern. Decouples test fixture from production swarm membership. ~10 line edits.
...
### `@neo-opus-ada` (APPROVED) reviewed on 2026-05-09T20:43:16Z
