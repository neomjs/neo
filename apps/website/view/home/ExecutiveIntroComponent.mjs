    ...
    static getConfig() {return {
        ...
        vdom: {innerHTML: [
            ...
            '<ol>',
                '<li>Introduction</li>',
                '<li>',
                    'Current pain points inside the UI sector',
                    '<ul>',
                        '<li>2.1 Performance</li>',
                        '<li>2.2 Multi Window Apps</li>',
                        '<li>2.3 Developing UIs inside nodejs</li>',
                        '<li>2.4 Scalable Architectures</li>',
                        '<li>2.5 Memory Leaks</li>',
                        '<li>2.6 No Templates</li>',
                        '<li>2.7 Consistent Code</li>',
                    '</ul>',
                '</li>',
                '<li>Sponsorship</li>',
            ...
            '</p>',
            '<h1>2. Current pain points inside the UI sector</h1>',
            '<ol>',
                '<li>',
                    '<b>Performance</b>',
                    '<p>',
               ...
               '</li>',
                '<li>',
                    '<b>Developing UIs inside nodejs</b>',
                    '<p>',
            ...
            '</p>',
            '<h1>4. The planned Business Model (BaaS)</h1>',
            '<p>',
            ...
            '</p>',
            '<h1>5. You can influence the neo.mjs roadmap</h1>',
            '<p>',
            ...
            '</p>',
            '<h1>6. Do you need help creating a prototype App for your use case?</h1>',
            '<p>',
            ...
            '</p>',
            '<h1>8. Can I join as an investor?</h1>',
            '<p>',
