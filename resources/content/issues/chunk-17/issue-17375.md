...
updatedAt: '2026-08-19T09:16:54Z'
...
- [ ] **AC-2:** the derived three are published without entering git in any repository. A guard fails if `users.jsonl`, `tracker.json` or `visited.json` is tracked in `neomjs/devindex`.
