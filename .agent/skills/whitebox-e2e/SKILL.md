...
If you are tasked with writing new End-to-End tests for Neo.mjs applications, you MUST immediately use the `view_file` tool to read and strictly adhere to `.agent/skills/whitebox-e2e/references/whitebox-e2e-protocol.md` before planning your assertions or writing any test code.
