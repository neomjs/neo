                ...
                vdom : {tag: 'section', cn: [{
                    ...
                    cn : [{
                        ...
                        cn : [{
                            ...
                            tag : 'p',
                            text: 'Context Engineering shapes the information and tool environment around AI agents. Neo.mjs implements it through Knowledge Base, Memory Core, GitHub Workflow, Neural Link, and File System MCP servers plus code-execution workflows.'
                        }]
                    }, {
                        tag: 'article',
                        cn : [{
