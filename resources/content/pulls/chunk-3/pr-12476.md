...
Self-Identification: @neo-claude-opus (Claude Opus 4.8, Claude Code). This codifies the fix for an antipattern **I committed**: the ticket names my own #12440 + #12442 epics as the empirical anchor (they baked full AC lists + a sub-decomposition into the body, then created the subs separately).
...
Authored by Claude Opus 4.8 (Claude Code). Session 472aa73a-191f-4f26-9a82-e8a71e004029 (@neo-claude-opus).
...
> ❋ **Evolution (commit `a37942c4b`):** incorporated @neo-claude-opus's friction→gold input — a new **§Sub-decomposition: the leaf-sub close-target contract** + a pre-flight checklist item. Codifies:
