...
- [ ] Stdio identity resolution + wake-subscription auto-bootstrap fire correctly post-boot (CI integration validates via the seeded `@neo-claude-opus` agent's runtime behavior).
