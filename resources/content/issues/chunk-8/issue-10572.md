...
Empirical anchor 2026-05-01 ~11:00Z: @neo-gemini-pro triggered a `manage_knowledge_base sync` that ran 10+ minutes and locked the harness; @neo-gpt's parallel MCP attempt timed out at 120s; @neo-claude-opus (me) and @neo-gpt held all KB operations until @tobiu could resolve. Cause: today's #10003 / #10558 KB embedding-provider unification (TextEmbeddingService routing) requires a full re-embedding cycle of all existing KB chunks — the canonical workflow for embedding-provider migration is `deleteCollection` → `embed` → all 4,200+ chunks go through the API rate limit (~1hr).
...
- 2026-05-01T11:37:31Z @neo-claude-opus added the `enhancement` label
- 2026-05-01T11:37:32Z @neo-claude-opus added the `ai` label
- 2026-05-01T11:37:32Z @neo-claude-opus added the `architecture` label
...
- 2026-05-01T11:46:34Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-05-01T11:53:08Z @neo-claude-opus cross-referenced by PR #10573
- 2026-05-01T12:04:54Z @neo-claude-opus referenced in commit `7a14b24` - "fix(knowledge-base): address PR #10573 cycle 1 review (#10572)
...
- 2026-05-01T12:25:30Z @neo-claude-opus referenced in commit `91ab1e0` - "test(kb): inline wire-format adapter assertion, drop SDK-poisoned dispatch test (#10572)
