...
const example = {
    ...
    items : {
        ...
        logs     : {reference: 'Logs',      title: 'Logs'},
        ...
        agents   : {reference: 'Agents',    title: 'Agents'},
        alerts   : {reference: 'Alerts',    title: 'Alerts'},
        history  : {reference: 'History',   title: 'History'}
    },
    nodes: {
...
test.describe('Neo.dashboard.dock.model.Authoring round trips', () => {
    ...
    test('preserves every catalog field and defaults minimal records without losing catalog-only items', () => {
        const document = {
            ...
            items : {
                a: {reference: 'OtherFactory', title: 'Full pane', closable: false,
