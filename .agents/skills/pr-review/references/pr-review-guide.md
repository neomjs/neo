...
3. **Author bypassed**: PR author lacks authority for the change (e.g., self-marking graduation on a Discussion authored by another peer; amending substrate they don't own without consultation; crossing peer-role §9 Non-Execution Boundary without explicit lead hand-off).
