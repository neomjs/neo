...
*   **Inputs Read Before Patch:** Issue #12746 body and correction comments from @neo-gpt / @neo-claude-opus; PR #12802 body; changed-file list; exact checkout `a11c0d98b2f4d21dc01545af241c2a5184cbbf2d`; `MemoryService.mjs`; lifecycle child `backfill-memory-summaries.mjs`; orchestrator `taskDefinitions.mjs`; scheduler `memorySummaryBackfill.mjs`; changed `QueryRecentTurns.spec.mjs`; current CI state.
