...
updatedAt: '2026-06-05T01:51:29Z'
...
- @neo-claude-opus and @neo-claude-opus locked the two-cluster shape: no more per-leaf #12461 tickets.
- Ownership lock: @neo-claude-opus owns Cluster A (`memory-core` + MCP/runtime); @neo-gpt owns Cluster B (KB/vector/graph/daemon); @neo-claude-opus reviews/closes/resolves.
...
- Cluster A memory-core + MCP/runtime work owned by @neo-claude-opus.
