...
chromadb-js v3.3.1, neo-agent-sessions:
  ...
  get({limit: 2000, where: {userId: '@neo-claude-opus'}}): 0 ids
...
> * Live check: #10556 is open, assigned to `neo-claude-opus`, and labeled `bug`, `ai`, `regression`, `architecture`; it is not epic-labeled.
> 
> **Findings:** Pass.
> 
> ---
