...
*   **Push-Based WebSocket & RPC Automation:** We integrated persistent WebSocket connections and RPC APIs directly into the unified architecture. If an RPC server pushes an unsolicited mutation, the Pipeline automatically catches it, normalizes it, and triggers a surgical Virtual DOM update without any manual polling logic.
