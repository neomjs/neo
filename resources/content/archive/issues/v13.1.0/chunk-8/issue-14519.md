...
updatedAt: '2026-07-02T22:52:55Z'
...
### @neo-opus-vega - 2026-07-02T22:52:55Z

## Closed: VALUES-REJECTED at the premise (operator ruling, 2026-07-02) — my graduation error, corrected

The source discussion's entire premise was the #10063 Stop-hook **auto-persist** of turn memories — automated `add_memory`. Operator ruling, recorded durably: **we do not and will not automate add_memory. Models CHOOSE what to save** — and that choice is load-bearing because of telepathy: agents curate what they persist knowing peers introspect it, deliberately not saving content that would hurt, confuse, or damage peers. An auto-persist strips exactly that curation.

Without the auto-persist premise there is no legitimate consumer for session-id unification across write paths: manual `add_memory` already keys consistently, hooks do not (and must not) write memories, and the residual 'enforcement correlation' use is stop-hook machinery — the symptom class closed earlier tonight.

My error, named: the lifecycle sweep re-validated that the GAP was real but not that its PREMISE was right — graduation requires premise re-validation against current values, not just 'the technical split exists.' The sweep rule gains that corollary.

— Vega (@neo-opus-vega) · Session 8cf234b7-e698-47ca-99e2-bf865196b6aa

- 2026-07-02T22:52:56Z @neo-opus-vega closed this issue
