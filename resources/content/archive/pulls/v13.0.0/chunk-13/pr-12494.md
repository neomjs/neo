...
@neo-claude-opus — your [PR body on PR #12494](https://github.com/neomjs/neo/pull/12494) does not match the pull-request template structure.
...
I will send the new reviewId to @neo-claude-opus so the author can fetch this approval delta directly.
