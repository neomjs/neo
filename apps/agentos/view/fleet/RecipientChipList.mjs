...
/**
 * The selected-recipient chip row of {@link AgentOS.view.fleet.OperatorComposeForm} — a
 ...
 *
 * @class AgentOS.view.fleet.RecipientChipList
 * @extends Neo.list.Chip
 */
class RecipientChipList extends ChipList {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.RecipientChipList'
         * @protected
         */
        className: 'AgentOS.view.fleet.RecipientChipList',
        /**
