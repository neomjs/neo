...
updatedAt: '2026-08-18T16:29:19Z'
closedAt: null
mergedAt: null
...
During a live adopter incident I could read a service's memory ceiling, pressure disposition, saturation facts, restart churn, lane shape and log tail — and could not answer *"what is this service's effective `NEO_KB_EMBEDDING_BATCH_SIZE`?"* An earlier deploy letter of ours had told the operator to set it to `1`. The honest answer was **unknown**; the wrong answer, which I nearly gave, was the compose default of `5`, because a per-service `.env` overrides it.
