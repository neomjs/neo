...
/**
 * @class DevRank.view.learn.MainContainerStateProvider
 * @extends Neo.state.Provider
 */
class MainContainerStateProvider extends StateProvider {
    static config = {
        /**
         * @member {String} className='DevRank.view.learn.MainContainerStateProvider'
         * @protected
         */
        className: 'DevRank.view.learn.MainContainerStateProvider',
        /**
         * @member {Object} data
         */
        data: {
             ...
             */
            contentPath: Neo.config.basePath + 'learn/guides/devrank/',
            /**
