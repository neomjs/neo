...
| PR adds identity/default/config-massage/module-helper debt | **Neo-Code Debt-Scan** - read [`audits/neo-code-debt-scan.md`](./audits/neo-code-debt-scan.md). <!-- trigger: Neo-code diff under ai/** or .agents/** --> |
