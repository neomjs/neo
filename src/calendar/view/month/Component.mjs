...
class Component extends BaseComponent {
    ...
    onWheelEnd() {
        ...
        for (; i < 12; i++) {
            flag = vdom.cn[1].cn[i].flag; // todo: #989 [not-ticket-ref: the open ticket tracking this todo] => get
                                          // the date of the first fully visible row for the header
        ...
        // todo: #990 [not-ticket-ref: the open ticket tracking this todo] => scroll the view to the closest row
    }
