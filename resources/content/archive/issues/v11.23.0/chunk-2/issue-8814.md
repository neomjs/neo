...
- 2026-01-20T03:43:57Z @tobiu referenced in commit `cb6f2df` - "fix: Resolve VDOM update race conditions (#8814)

Implemented a comprehensive fix for duplicate DOM nodes caused by race conditions between parent and child updates.

- VDomUpdate: Added descendant tracking (Reverse Lookup).

- VdomLifecycle: Added isChildUpdating guard.

- TreeBuilder: Added Wake-Up expansion for unmounted children.

- VdomHelper: Added neoIgnore skip for inserts.

- Added extensive regression tests."
