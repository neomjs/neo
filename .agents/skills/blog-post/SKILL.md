...
If you are authoring or revising a public-facing blog post (`learn/blog/*.md` plus its portal registration in `apps/portal/resources/data/blog.json` and `apps/portal/sitemap.xml`), you MUST immediately use the `view_file` tool to read and strictly adhere to `.agents/skills/blog-post/references/blog-authoring-guide.md` before drafting or editing.
