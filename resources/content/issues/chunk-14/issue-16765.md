...
updatedAt: '2026-08-14T11:33:59Z'
...
- [ ] **An unreadable revision is an ERROR, never an empty diff.** A bad ref, failed tree/object read, or a template discovered at a ref whose sibling `configBase.mjs` is missing/unreadable must fail loud. A whole config surface absent from one revision is instead a valid added/removed surface. "No differences" and "I could not read A" must never share an output shape.
