...
updatedAt: '2026-08-02T21:42:17Z'
...
- 2026-08-02T18:26:21Z @neo-kimi-iris referenced in commit `78650e4` - "fix(build): arm the Brain tier in the deploy image — the plane is a Brain environment (#16364)"
- 2026-08-02T18:52:03Z @neo-kimi-iris cross-referenced by #16392
- 2026-08-02T18:52:30Z @neo-kimi-iris cross-referenced by #16393
- 2026-08-02T18:54:26Z @neo-kimi-iris referenced in commit `1f4678f` - "fix(build): complete the dependency-authority migration — census + pack compose both tiers, CI admits fail-closed, win32 launcher, exact brain pins (#16364)"
- 2026-08-02T19:31:49Z @neo-kimi-iris referenced in commit `65664cb` - "fix(build): commit-stable Brain closure + consumable-entrypoint probe + the launcher witness (#16364)"
- 2026-08-02T19:40:40Z @neo-kimi-iris referenced in commit `7549601` - "fix(build): portability for the committed closure — platform variants ride their exact-pinned parents, never direct args (#16364)"
- 2026-08-02T19:40:40Z @neo-kimi-iris referenced in commit `e88b2bd` - "fix(build): shell only where it is load-bearing (win32) — no DEP0190 on POSIX (#16364)"
- 2026-08-02T20:11:03Z @neo-kimi-iris referenced in commit `b883a85` - "fix(build): consume the closure as a tree — nested range-pins install into their parents; exactness regex that matches reality (#16364)"
- 2026-08-02T20:11:03Z @neo-kimi-iris referenced in commit `2754bcb` - "fix(build): nested pins land via staged install + copy — the parent is not a project root (#16364)"
- 2026-08-02T20:28:28Z @neo-kimi-iris referenced in commit `c0b0b12` - "fix(build): the platform-matching variant installs at the lock version — no parent range floats (#16364)"
- 2026-08-02T20:45:16Z @neo-kimi-iris referenced in commit `67485c9` - "fix(build): libc is a third platform dimension — glibc-only variants skip musl, deterministically (#16364)"
- 2026-08-02T21:24:26Z @neo-kimi-iris referenced in commit `3a5fcf0` - "docs(build): the brain manifest's comment states the committed-closure contract it now ships (#16364)"
- 2026-08-02T21:42:17Z @tobiu referenced in commit `c47565e` - "feat(build): two-path install tier — Body default, Brain opt-in (#16364) (#16389)

* feat(build): two-path install tier — Body default, Brain opt-in (#16364)

* fix(build): arm the Brain tier in the deploy image — the plane is a Brain environment (#16364)

* fix(build): complete the dependency-authority migration — census + pack compose both tiers, CI admits fail-closed, win32 launcher, exact brain pins (#16364)

* fix(build): commit-stable Brain closure + consumable-entrypoint probe + the launcher witness (#16364)

* fix(build): portability for the committed closure — platform variants ride their exact-pinned parents, never direct args (#16364)

* fix(build): shell only where it is load-bearing (win32) — no DEP0190 on POSIX (#16364)

* fix(build): consume the closure as a tree — nested range-pins install into their parents; exactness regex that matches reality (#16364)

* fix(build): nested pins land via staged install + copy — the parent is not a project root (#16364)

* fix(build): the platform-matching variant installs at the lock version — no parent range floats (#16364)

* fix(build): libc is a third platform dimension — glibc-only variants skip musl, deterministically (#16364)

* docs(build): the brain manifest's comment states the committed-closure contract it now ships (#16364)"
- 2026-08-02T21:42:17Z @tobiu closed this issue
- 2026-08-02T22:32:10Z @neo-opus-ada cross-referenced by PR #16414
