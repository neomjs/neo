...
- 2025-07-04T12:06:48Z @tobiu referenced in commit `2251e70` - "#6935 concept exploration"
- 2025-07-04T12:06:48Z @tobiu referenced in commit `5d1dcca` - "#6935 Reached the PoC state"
- 2025-07-04T12:06:48Z @tobiu referenced in commit `f58d01d` - "#6935 flexbox layout fix"
- 2025-07-04T12:06:48Z @tobiu referenced in commit `a84f648` - "#6935 component.Base: beforeSetKeys() => restored to the old value"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `226064f` - "#6935 component.Base: restored cls & style configs to their dev branch value"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `151c0d3` - "#6935 core.Base: simplified the id generation, collection.Base: specific id for the allItems collection"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `54c149b` - "#6935 container.Base: cleanup"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `323ca32` - "#6935 core.Config: JSDoc, changed the initial value setting strategy to not lose meta objects."
- 2025-07-04T12:06:49Z @tobiu referenced in commit `f007668` - "#6935 component.Base: vnode config => descriptor"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `18a4e71` - "#6935 component.Base: removed afterSetFlex() => flex is not a config"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `5410bf6` - "#6935 core.Base: construct() => ensure to only create config instances for keys that should be configs"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `bcad089` - "#6935 core.Base: isConfig() => only reactive keys"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `c1997a5` - "#6935 core.Base: -testing log"
- 2025-07-04T12:06:49Z @tobiu referenced in commit `32e119a` - "#6935 core.Base: construct() => find all real configs"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `751172c` - "#6935 core.Base: construct() => meaningful JSDoc comment"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `c5f1def` - "#6935 core.Base: construct() => meaningful JSDoc comment => inheritance for reactive configs"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `eec09e2` - "#6935 core.Base: construct() => meaningful JSDoc comment => polishing"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `787019c` - "#6935 core.Base: experimenting with lazy Config initialization"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `a170dfe` - "#6935 cleanup"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `09b7eb5` - "#6935 core/Config: cleanup"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `e764ef8` - "#6935 core/Config: set() => return a boolean, if there was a change, Neo.mjs: set() rely on the boolean for triggering afterSet*"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `8cea16d` - "#6935 added the feature request to the feature branch for further refinement. note: must be removed before merging to dev."
- 2025-07-04T12:06:50Z @tobiu referenced in commit `1a4d844` - "#6935 .md file: add the latest version of core.Config"
- 2025-07-04T12:06:50Z @tobiu referenced in commit `9750089` - "#6935 .md file: lazy initialization"
- 2025-07-04T12:06:51Z @tobiu referenced in commit `51a194a` - "#6935 core.Base: most elegant solution for assigning ids first."
- 2025-07-04T12:06:51Z @tobiu referenced in commit `dad01b2` - "#6935 layout.Card: loadModule() => tmp parentId fix"
- 2025-07-04T12:06:51Z @tobiu referenced in commit `d84ceff` - "#6935 feature request update"
- 2025-07-04T12:06:51Z @tobiu referenced in commit `3eca215` - "#6935 container.Base: ensuring lazy-loaded items get parentId & parentIndex"
- 2025-07-04T12:06:51Z @tobiu referenced in commit `9596509` - "#6935 container.Base: re-adding mergeConfig()"
- 2025-07-04T12:06:51Z @tobiu referenced in commit `a590565` - "#6935 Portal.view.learn.MainContainerController: default route fix"
