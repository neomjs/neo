 ...
 * unselect), and the CURRENT selection renders through {@link AgentOS.view.fleet.mailbox.RecipientChipList}
 ...
 *
 * @class AgentOS.view.fleet.mailbox.ComposeForm
 * @extends Neo.form.Container
 */
class OperatorComposeForm extends FormContainer {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.mailbox.ComposeForm'
         * @protected
         */
        className: 'AgentOS.view.fleet.mailbox.ComposeForm',
        /**
