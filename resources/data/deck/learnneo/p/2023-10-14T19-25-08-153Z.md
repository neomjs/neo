...
actually used in the example, and the import root path is different to reflect the location
of the Neo.mjs libarary relative to the examples.

If you run the example you'll see one huge button. That's because the container is configured to 
...
class MainView extends Base {
    static config = {
        ...
        layout: 'fit',
        // layout: {ntype:'vbox', align:'start'}, // Try using this layout instead of 'fit'
        items : [{
            module: Button,
            text  : 'Button'
        }]
