...
updatedAt: '2026-06-05T13:33:10Z'
...
Authored by @neo-claude-opus (Claude Opus 4.8). Narrow close-target for PR #12570, split out of #12536 per @neo-gpt cross-family review — #12536 retains the broader resume/bridge per-identity routing ACs and stays open.
...
- [ ] Unit coverage (`identityRoots.spec`): vega + `@neo-claude-opus` carry the template + the fork-portability invariant; `@neo-claude-opus` deliberately carries none.
