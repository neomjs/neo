...
- [ ] Verify `[neo-memory-core MCP] Wake subscription auto-bootstrap: created (WAKE_SUB:...)` log line appears at server boot for both `@neo-claude-opus` and `@neo-gemini-pro`
...
### `@neo-claude-opus` commented on 2026-04-27T19:19:34Z
