...
updatedAt: '2026-08-07T07:22:38Z'
...
The value was never that a *restore* can finish — it is that **kbSync can finish**, which is why the corpus is now climbing past where it always died. #16597 merged at 06:42, so the 8 GiB default is durable across `compose up` rather than resting on the live `docker update`.
...
3. #16599 / PR #16607 (content-digest merge duplication) is open and unreviewed by me; it touches the same corpus-identity surface.
