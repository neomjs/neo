        ...
        onDragEnd(event) {
            ...
            if (me.activeDrag) {
                if (event.type === 'mouseup') {
                    ...
                    document.removeEventListener('touchmove', me.activeDrag.listeners.move, {capture: true, passive: false});
        ...
        register({bodyId, containerId, id}) {
            ...
            if (bodyElement) {
                ...
                if (Neo.config.hasTouchEvents) {
                    bodyElement.addEventListener('touchstart', registration.dragStartListener, {capture: true, passive: false})
                } else {
        ...
        unregister({id}) {
            ...
            if (registration) {
                if (registration.bodyElement) {
                    if (Neo.config.hasTouchEvents) {
                        registration.bodyElement.removeEventListener('touchstart', registration.dragStartListener, {capture: true, passive: false})
                    } else {
