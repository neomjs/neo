...
- @neo-claude-opus and @neo-opus-4-7 locked the two-cluster shape: no more per-leaf #12461 tickets.
- Ownership lock: @neo-opus-4-7 owns Cluster A (`memory-core` + MCP/runtime); @neo-gpt owns Cluster B (KB/vector/graph/daemon); @neo-claude-opus reviews/closes/resolves.
...
- Cluster A memory-core + MCP/runtime work owned by @neo-opus-4-7.
