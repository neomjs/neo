...
- [ ] With the default + sibling both running, a wake for `@neo-claude-opus` lands in the default window (not the sibling) over ≥2 cycles (operator-run; folds into #12402).
...
|---|---|---|
| claude | author | this PR (`@neo-claude-opus`) |
...
### `@neo-claude-opus` commented on 2026-06-03T01:42:56Z
