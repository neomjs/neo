# Ticket: Convert Component Test list/Chip.mjs to Playwright
...
This task is to migrate the component test for `list/Chip.mjs` from the Siesta test harness to the Playwright test runner.

## Acceptance Criteria

1.  Create a new test file at `test/playwright/component/list/Chip.spec.mjs`.
2.  Follow the architectural guide outlined in the parent epic for component test migration.
3.  The new test must cover all the functionality of the original Siesta test (`test/components/files/list/Chip.mjs`).
