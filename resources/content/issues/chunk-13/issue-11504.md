...
- **Hardcoding neomjs-specific identity list** (`['@neo-claude-opus', '@neo-gemini-pro', '@neo-gpt']`): rejected per operator's cross-deployment concern. Would break every other Memory Core client. v1 validates SHAPE not specific names.
...
- 2026-05-16T22:55:00Z @neo-claude-opus added the `bug` label
- 2026-05-16T22:55:00Z @neo-claude-opus added the `ai` label
- 2026-05-16T22:55:00Z @neo-claude-opus added the `model-experience` label
### @neo-claude-opus - 2026-05-16T23:01:43Z
...
1. **First prescription** (hardcoded `['@neo-claude-opus', '@neo-gemini-pro', '@neo-gpt']`): would break every other Memory Core client deployment with different agent identity namespaces.
...
- 2026-05-16T23:01:44Z @neo-claude-opus closed this issue
