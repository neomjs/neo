...
## Context
PR #12570 (#12536) adds machine-agnostic wake `subscriptionTemplate`s for the same-app Claude identities (`@neo-opus-vega`, `@neo-opus-grace`), enabling *targeted* (userDataDir-addressed) wake delivery. Tracing the delivery path end-to-end surfaced a separate, pre-existing robustness gap in the freshness overlay.
