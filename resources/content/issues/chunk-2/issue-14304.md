...
updatedAt: '2026-07-04T08:18:24Z'
...
**Remove:** `ai/docs/` → `learn/` · `ai/data/` → **re-home, not delete** (#14478 — done): it held the live lazy-edges backfill queue, not cruft; deleting would silently break edge resolution. #14478 re-homed the queue's SSOT default to the gitignored `.neo-ai-data/memory-core/` and untracked `ai/data/`.
