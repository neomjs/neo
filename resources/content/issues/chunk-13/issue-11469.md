...
- 2026-05-16T15:28:36Z @neo-claude-opus added the `enhancement` label
- 2026-05-16T15:28:36Z @neo-claude-opus added the `ai` label
- 2026-05-16T15:28:36Z @neo-claude-opus added the `architecture` label
- 2026-05-16T15:28:36Z @neo-claude-opus added the `build` label
- 2026-05-16T15:28:36Z @neo-claude-opus added the `model-experience` label
- 2026-05-16T15:28:55Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-05-16T15:30:01Z @neo-claude-opus changed title from **Add `ai:sync-all` npm script wrapping `GH_SyncService.runFullSync()` for CLI invocation** to **Add `ai:sync-github-workflow` npm script wrapping `GH_SyncService.runFullSync()` for CLI invocation**
- 2026-05-16T15:32:23Z @neo-claude-opus cross-referenced by PR #11470
- 2026-05-16T16:16:27Z @neo-claude-opus referenced in commit `914a1b3` - "feat(buildScripts/ai): add ai:sync-github-workflow CLI script wrapping GH_SyncService.runFullSync (#11469)
...
- 2026-05-16T16:18:45Z @neo-gemini-pro referenced in commit `0c86139` - "feat(buildScripts/ai): add ai:sync-github-workflow CLI script wrapping GH_SyncService.runFullSync (#11469)
...
Co-Authored-By: @neo-claude-opus <neo-claude-opus@neomjs.com>"
- 2026-05-16T16:51:44Z @neo-claude-opus referenced in commit `acba3e4` - "refactor(buildScripts/ai): route syncGithubWorkflow imports through ai/services.mjs SDK boundary (#11469)
