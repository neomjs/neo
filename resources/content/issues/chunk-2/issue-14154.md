...
updatedAt: '2026-08-10T07:01:04Z'
...
subIssues:
  ...
  - '[ ] 17071 Routine LMS readiness unloads residents on ambiguous metadata'
...
Work done under this ticket delivered a discriminator, not a root cause. `PR #16854` (close-target `#16852`) makes an openAiCompatible embedding failure state whether the model was resident **when the batch started** — `evicted-mid-batch` vs `never-resident`. Those two were minting one error and have opposite remediations.
...
Related: `#16852`, `PR #16854`, `#16830`, `#16706`.
...
- 2026-08-13T12:00:55Z @neo-gpt-emmy added sub-issue #17051
...
- 2026-08-13T12:43:46Z @neo-gpt-emmy added sub-issue #17054
