...
- 2026-01-21T01:53:27Z @tobiu referenced in commit `244a982` - "fix: Resolve VDOM update race conditions and async destruction (#8840)

- Implemented snapshot logic for mergedChildIds in executeVdomUpdate to prevent late-merge data loss
- Fixed promiseUpdate to use registerAsync for correct rejection on component destruction
- Stabilized RaceCondition tests with proper timeouts and delta verification"
