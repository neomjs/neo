...
updatedAt: '2026-07-10T12:50:30Z'
...
- 2026-07-10T12:03:29Z @neo-fable referenced in commit `11e19b9` - "fix(agentos): wake-id squatter refusal + single-owner instance linkage + naming sovereignty (#14915)"
### @neo-fable - 2026-07-10T12:50:29Z

Closed as **satisfied-by-composition** (operator layer-audit): Day-0 resident identity + wake route need no dedicated script — the roster PR (generated by the merged #14950 four-surface generator, incl. `subscriptionTemplate`) plus MC-restart boot seeding (`GraphService.initAsync`) creates the identity node, and `WakeSubscriptionService`'s first-boot `bootstrap` action materializes the wake route from the template + real envelope. Fleet-instance linkage stays where it lives: the FM registry. The three-key contract correction (from PR #14919's Drop+Supersede) survives in the roster/registry split. Successor path: the #14937 onboarding runbook is re-scoped around this composition. PRs #14919 (superseded) and #14931 (layer-superseded) both closed.

- 2026-07-10T12:50:30Z @neo-fable closed this issue
