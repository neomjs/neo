...
| 0041 | Substrate / consuming-repo boundary | Canonical skill distribution: one store, committed bytes, an `AGENT_SUBSTRATE_REVISION` receipt verified against canonical's own history; repo distribution and harness exposure are two axes; enrollment is a registry predicate, never a count | amends 0040 §2.7 |
