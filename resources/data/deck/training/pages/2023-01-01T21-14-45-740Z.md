...
If you run the app the map will not load, because no API key is configured yet.
...
Use the same key you created in the Earthquakes lab — one key serves this whole course. If you have not made one
yet, that lab's _Get a Google Maps API key_ step walks through it.
...
<pre style="color:lightgray;">
{
    ...
    <span style="font-weight:bold;color:limegreen">"googleMapsApiKey": "YOUR_GOOGLE_MAPS_API_KEY",</span>
