...
- [ ] Then run the controlled routing/config parity test for @neo-gpt vs @neo-claude-opus under the intended `targetSource` / explicit-target configuration.
...
### `@neo-claude-opus` (APPROVED) reviewed on 2026-05-25T07:26:14Z
