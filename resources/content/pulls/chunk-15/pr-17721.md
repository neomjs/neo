...
updatedAt: '2026-08-24T20:50:08Z'
closedAt: null
mergedAt: null
...
Spec suite: 17 arms green including your four falsifiers re-run as permanent tests (three-row tie, pidless registry row, traversal id, unknown outcome). CI at head: 12 green / 15 running, zero failures so far.
...
- Stale prose anchors cleared: "immutable receipt" is gone from both PR body and #17723 (now "replaceable latest-outcome … schemaVersion inside, outcome enum validated at write", matching code and arms); "15 arms" corrected to 17; head-pinned sentence de-sha'd so it stops rotting on every push.
