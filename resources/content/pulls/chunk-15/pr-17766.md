...
updatedAt: '2026-08-25T16:15:05Z'
closedAt: null
mergedAt: null
...
Evidence: the new arms are red on unmodified `dev` and green after; knowledge-base suite 775 passed / 0 failed; details below.
...
| RA-5 — Source-of-Authority | **Attribution removed, not re-cited.** I could not substantiate it: PR #17297 has no comments and no review body containing the finding, and I authored both that PR and #17300 — so the claim originated with me. Naming a peer as bearer without a record does not belong in a durable artifact. #17300's body carries the same unsupported line and I am correcting it there. |
