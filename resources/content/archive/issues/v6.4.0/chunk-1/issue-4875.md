---
id: 4875
title: 'button.Base, menu.List => remove the negative offsets for showing popovers'
state: CLOSED
labels:
  - enhancement
assignees:
  - tobiu
createdAt: '2023-09-11T10:02:57Z'
updatedAt: '2023-09-11T10:03:23Z'
githubUrl: 'https://github.com/neomjs/neo/issues/4875'
author: tobiu
commentsCount: 0
parentIssue: null
subIssues: []
...
blockedBy: []
blocking: []
closedAt: '2023-09-11T10:03:23Z'
---
# button.Base, menu.List => remove the negative offsets for showing popovers

there was a theme build missing on my end, not needed.

@ExtAnimal 

## Timeline

- 2023-09-11T10:02:58Z @tobiu added the `enhancement` label
- 2023-09-11T10:02:58Z @tobiu assigned to @tobiu
- 2023-09-11T10:03:20Z @tobiu referenced in commit `6e68118` - "button.Base, menu.List => remove the negative offsets for showing popovers #4875"
- 2023-09-11T10:03:23Z @tobiu closed this issue
