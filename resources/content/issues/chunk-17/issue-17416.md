...
updatedAt: '2026-08-20T13:05:22Z'
...
[D#16794](https://github.com/orgs/neomjs/discussions/16794) is an adjacent authority, not a duplicate. It converged on one admitted writer, a revisioned `GitMirror` feed, and truthful per-facet projection receipts, but its current A5/B5 shape mirrors `neomjs/neo`. A dedicated corpus repository changes that source boundary and must revalidate the design rather than creating a parallel projection writer.
...
|---|---|---|---|
| **A — dedicated corpus repository first; no Neo history rewrite** | **Recommendation for graduation review** | Generated-content custody and consumer parity can move independently of the wider code split | **Evidence:** multi-repo ingestion exists; mirror churn is measured; ADR 0004 makes the corpus regeneratable. **Falsifier:** shadow output cannot preserve typed Graph, KB retrieval, and Portal route parity from one revisioned source |
...
- D#16794's A5/B5 feed currently mirrors `neomjs/neo`; a dedicated corpus source requires revalidation.
