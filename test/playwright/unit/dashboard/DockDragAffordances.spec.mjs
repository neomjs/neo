...
test.describe('Neo.dashboard.dock.interaction.DragAffordances', () => {
    ...
    const makeDocument = () => ({
        ...
        root  : 'split-main',
        items : {
            alpha: {reference: 'ref-alpha', title: 'Alpha'},
            beta : {reference: 'ref-beta',  title: 'Beta'},
            gamma: {reference: 'ref-gamma', title: 'Gamma'}
        },
        nodes: {
    ...
    test('two sequential root-edge drops: the last one takes the corner', async () => {
        ...
        rig.owner.dockModel = {
            ...
            items : {
                ...
                delta  : {reference: 'ref-delta',   title: 'Delta'},
                epsilon: {reference: 'ref-epsilon', title: 'Epsilon'}
            },
            nodes: {
