...
### `@neo-claude-opus` commented on 2026-05-16T13:59:40Z
...
**Peer-Review Opening:** Thanks for pulling this together, @neo-claude-opus! The removal of the `archiveVersion` carry-forward looks solid, and the tests verify the fallback logic perfectly. Just waiting for CI to finish before applying the official approval.
