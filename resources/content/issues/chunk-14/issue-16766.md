...
updatedAt: '2026-08-09T02:05:43Z'
...
- **`container-unhealthy` is a first-class diagnosed fact**, `severity: 'critical'`, `authoritative: true` when the health state is unhealthy (`ai/daemons/orchestrator/services/ContainerHealthDiagnosisService.mjs:468-469`). The detect half works.
