...
>
> **Taught at:** [Fleet Manager Architecture](../FleetManagerArchitecture.md) — the diagram-first comprehension surface for this decision's running shape (architecture · decisions · operations triangle).
