...
updatedAt: '2026-07-10T17:20:43Z'
...
3. **Vocabulary honesty in the cockpit** (UI half, coordinates with @neo-opus-vega's #14807/#14960 account-model work): a selectable-but-unlaunchable family renders its honest reason (no template / detached-only) instead of failing at start — the same honest-states discipline PR #14952 landed for source provenance.
...
- [ ] Any GUI-only family: EITHER the detached class lands with honest non-supervision semantics (post @neo-gpt design loop-in) OR the family renders honestly-unlaunchable in registry/UI
- [ ] `native-neo` deferral named in the template JSDoc
- [ ] Cross-family review

## Out of Scope

The generic-by-default adapter refactor (#13796 — this ticket adds coverage inside today's per-family shape); cockpit Add-Peer UI implementation (#14807, consumes the widened vocabulary).

## Related

Parent: #13015 · launch seam: #14914 (PR #14918) · conductor: #14937 (PR #14965, merged) · UI honesty precedent: #14643 (PR #14952) · adjacent philosophy: #13796.
