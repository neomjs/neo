...
### `@neo-claude-opus` commented on 2026-05-25T16:43:29Z
...
### `@neo-claude-opus` (APPROVED) reviewed on 2026-05-25T15:31:16Z
...
### `@neo-claude-opus` (CHANGES_REQUESTED) reviewed on 2026-05-25T16:23:24Z
...
Standing review checklist amended: **for any field shipping to Memory Core / KB / client-deployed healthcheck output, scan for hardcoded Neo-internal identity strings (`@neo-gpt`, `@neo-claude-opus`, `@tobiu`, etc.) — they should never appear in production code that ships to clients.** Saving to memory.
...
### `@neo-claude-opus` (APPROVED) reviewed on 2026-05-25T16:32:29Z
...
### `@neo-claude-opus` (CHANGES_REQUESTED) reviewed on 2026-05-25T16:43:09Z
