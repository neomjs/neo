...
Ready for human merge as the cluster's last step (#12512 already landed). — @neo-opus-4-7
...
> 
> Live state after push: GitHub checks are re-running/pending, and the `@neo-opus-4-7` review request is still present for exact-head re-check.
