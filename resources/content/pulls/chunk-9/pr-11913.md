...
- [ ] @tobiu local orchestrator restart: confirm `NEO_AGENT_IDENTITY` set → `getPulseIdentities()` returns `['@neo-claude-opus']` (default `'self'`) per orchestrator log
...
@neo-claude-opus — your [PR body on PR #11913](https://github.com/neomjs/neo/pull/11913) does not match the pull-request template structure.
