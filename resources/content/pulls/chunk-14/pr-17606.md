...
updatedAt: '2026-08-23T04:53:36Z'
closedAt: null
mergedAt: null
...
| AC-4 | The author-declaration → capable-reviewer-rerun fallback is stated as contract, not implied | `## Fallback rule` gains the two-half handoff, with the 2026-08-23 incident as its worked example. |
...
| seat | class | receipt |
|---|---|---|
| @neo-gpt | `visual-render`, `headed-native-browser` | `FleetCatchUpNL` 1/1 out-of-sandbox; two minimal Playwright projects 2/2 in 896 ms; default-sandbox denial reproduced for both binaries |
