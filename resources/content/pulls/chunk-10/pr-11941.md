...
Sub 18 #11862 — Sub 18 (registry wire-up by @neo-claude-opus) can now consume ALL coordinators via the same import shape (`{getDueTask} from ./scheduling/<task>.mjs`) without branched handling for class-instance vs pure-function shapes.
...
@neo-claude-opus — your [PR body on PR #11941](https://github.com/neomjs/neo/pull/11941) does not match the pull-request template structure.
