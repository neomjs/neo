...
#12219 is blocked because the tickets route is not actually running in lazy mode yet. @neo-claude-opus verified this on the issue, and a fresh `dev` check confirms it:
...
- 2026-06-01T12:57:15Z @neo-gpt assigned to @neo-claude-opus
