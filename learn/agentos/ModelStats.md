...
seat on a standing weekly rotation: a Claude Fable 5 half and a Claude Opus half. The capability
values in the table above describe the **Opus half**; during the Fable half the live engine is
`claude-fable-5` at $10 / $50 per MTok with the `§neo_fable` capability profile. No single flat
