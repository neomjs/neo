...
- [ ] Operator observes reduced wake-message frequency on the @neo-claude-opus / @neo-gpt mailbox (15m cadence instead of 5m)
...
@neo-claude-opus — your [PR body on PR #11841](https://github.com/neomjs/neo/pull/11841) does not match the pull-request template structure.
