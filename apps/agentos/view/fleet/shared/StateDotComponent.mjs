 ...
 * in the component SCSS (`resources/scss/src/apps/agentos/fleet/shared/StateDotComponent.scss`). The color — not the
 * motion — carries the signal, so the primitive
 * degrades cleanly for reduced-motion users. Composed by every fleet surface.
 *
 * @class AgentOS.view.fleet.shared.StateDotComponent
 * @extends Neo.component.Base
 */
class StateDot extends Component {
    static config = {
        /**
         * @member {String} className='AgentOS.view.fleet.shared.StateDotComponent'
         * @protected
         */
        className: 'AgentOS.view.fleet.shared.StateDotComponent',
        /**
