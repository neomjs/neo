...
/**
 * @class Neo.dashboard.DockDragAffordances
 ...
 */
class DockDragAffordances extends Base {
    static config = {
        /**
         * @member {String} className='Neo.dashboard.DockDragAffordances'
         * @protected
         */
        className: 'Neo.dashboard.DockDragAffordances'
    }
    ...
    /**
     * The indicator-menu overlay instance (Neo.dashboard.DockDropIndicators).
     * @member {Neo.dashboard.DockDropIndicators|null} indicators=null
     */
    indicators = null
    ...
    /**
     * The preview renderer overlay instance (Neo.dashboard.DockPreview).
     * @member {Neo.dashboard.DockPreview|null} preview=null
     */
    preview = null

    /**
     * The candidate producer — created here, destroyed here.
     * @member {Neo.dashboard.DockPreviewProducer|null} producer=null
     */
    producer = null
...
export default Neo.setupClass(DockDragAffordances);
