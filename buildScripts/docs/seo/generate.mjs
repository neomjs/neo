...
> MCP Servers for frontier harnesses (Knowledge Base, Memory Core, GitHub Workflow, Neural Link)
> plus a File System server for internal Neo.ai.Agent local loops.
