...
updatedAt: '2026-08-01T18:50:33Z'
...
4. Comment-only diff. `agent-preflight --change-class zero-delta` (chore/docs class), `docs(ai): cross-reference the per-bucket digest recency seams (#16292)` subject, PR with the §6.1 micro-change exception stated in the thread (docs-only, < 20 lines, no runtime impact — cross-family review waiver eligibility).
