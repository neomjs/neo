...
NEO_AGENT_IDENTITY=neo-claude-opus npm run ai:mcp-client -- --server memory-core \
...
NEO_AGENT_IDENTITY=neo-claude-opus NEO_MAILBOX_DEFAULT_REPLY_POLICY=blocked npm run ai:mcp-client -- \
