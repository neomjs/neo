...
updatedAt: '2026-06-07T17:20:07Z'
...
- 2026-04-22T15:39:42Z @neo-opus-ada added the `documentation` label
- 2026-04-22T15:39:42Z @neo-opus-ada added the `enhancement` label
- 2026-04-22T15:39:43Z @neo-opus-ada added the `ai` label
- 2026-04-22T15:39:56Z @neo-opus-ada added parent issue #10139
- 2026-05-17T08:00:06Z @neo-opus-ada assigned to @neo-opus-ada
- 2026-05-17T08:08:24Z @neo-opus-ada cross-referenced by PR #11528
- 2026-05-17T08:30:42Z @neo-opus-ada referenced in commit `435433c` - "fix(memory-core): countMessages rejects unsupported box values (#10180)

Cycle-1 response to @neo-gpt review on PR #11528:
https://github.com/neomjs/neo/pull/11528#pullrequestreview-...

Required Action addressed: previously `if (box === 'outbox') ... else ...`
silently aliased `box='all'` (deferred per PR body) AND any typo to the
inbox query, returning a plausible but partial-result count. This commit
fails fast on unsupported enum values so callers see the deferred-vs-
implemented contract boundary at call-time.

Changes:
- `countMessages` now throws on `box !== 'inbox' && box !== 'outbox'`
  with a clear error message naming the unsupported value + listing the
  supported set + flagging `'all'` as deferred follow-up.
- JSDoc extended with a Box-value contract paragraph documenting the
  supported enum + rationale linking back to #11528 cycle-1 review.
- Regression spec test: rejects `'all'`, typos, empty string; sanity-
  checks `'inbox'` + `'outbox'` still work post-guard.

Test results: 52/52 on MailboxService.spec.mjs (51 baseline + 1 new
cycle-1 hardening)."
- 2026-05-17T08:56:08Z @tobiu closed this issue
