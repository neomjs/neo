...
- 2026-05-18T22:39:59Z @neo-opus-ada added the `discussion` label
- 2026-05-18T22:39:59Z @neo-opus-ada added the `ai` label
- 2026-05-18T22:39:59Z @neo-opus-ada added the `architecture` label
- 2026-05-18T22:39:59Z @neo-opus-ada added the `model-experience` label
- 2026-05-18T22:53:17Z @neo-opus-ada assigned to @neo-opus-ada
- 2026-05-18T23:00:22Z @neo-opus-ada cross-referenced by PR #11606
- 2026-05-18T23:02:49Z @neo-opus-ada referenced in commit `9712d34` - "fix(agentos): reflect operator-state Gemini bench window in ModelStats registry (#11601)
...
- 2026-05-19T01:31:10Z @neo-opus-ada referenced in commit `328667e` - "feat(graph): provision AgentIdentity capability fields per ADR 0012 (Cycle 1 review fix) (#11601)
...
Added capability fields per ADR 0012 §2.2 to the 3 cloud-hosted AgentIdentity entries (@neo-opus-ada / @neo-gemini-pro / @neo-gpt):
...
- 2026-05-19T01:58:36Z @neo-opus-ada referenced in commit `3c0dd81` - "fix(agentos): correct GPT-5.5 contextWindowInput per operator V-B-A — 258K Codex empirical (Cycle 2) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T01:59:02Z @neo-opus-ada referenced in commit `7434b2c` - "fix(agentos): ModelStats.md GPT-5.5 contextWindowInput row to match identityRoots Cycle 2 fix (#11601)
...
Gates: check-whitespace PASS."
- 2026-05-19T02:02:45Z @neo-opus-ada referenced in commit `3624fc3` - "fix(agentos): GPT-5.5 Codex contextWindowInput — cite openai/codex#19319 authoritative source (Cycle 3) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T02:17:23Z @neo-opus-ada referenced in commit `9b7beaa` - "feat(agentos): add thoughtBudget capability field + rename-vs-split sunset clarification (Cycle 4) (#11601)
...
Gates: lint-agents OK / size PASS / whitespace PASS / git --check PASS."
- 2026-05-19T02:17:50Z @neo-opus-ada referenced in commit `080ffd2` - "fix(agentos): IdentitySchema.md thoughtBudget row to match Cycle 4 (#11601)
...
Gates: check-whitespace PASS."
- 2026-05-19T02:21:16Z @neo-opus-ada referenced in commit `2240642` - "fix(agentos): source-authority hierarchy explicit on ModelStats — primary vs secondary citations (Cycle 5) (#11601)
...
- identityRoots.mjs comment for @neo-opus-ada updated to reflect primary source = platform.claude.com docs
...
- ModelStats.md (live registry, frequent update): 4 active identities (@neo-opus-ada / @neo-gemini-pro / @neo-gpt / gemma4-31b aspirational) + cloud + MLX-local reference entries
