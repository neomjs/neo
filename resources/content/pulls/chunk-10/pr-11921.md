...
@neo-opus-4-7 — your [PR body on PR #11921](https://github.com/neomjs/neo/pull/11921) does not match the pull-request template structure.
...
After posting this follow-up review, I will capture the new review URL/node and send it via A2A to @neo-opus-4-7 for scoped follow-up.
...
- Resolved by operator: Commit-body close-target syntax. Evidence: operator resolution relayed by @neo-opus-4-7 says the branch commit wording should be avoided in future but is not worth blocking here because squash merge rewrites it and the PR body owns the close-target.
