...
updatedAt: '2026-06-26T05:37:20Z'
closedAt: null
mergedAt: null
...
- `npm run test-unit -- test/playwright/unit/ai/scripts/maintenance/defragMemoryCoreRepair.spec.mjs` -> 27 passed before and after rebasing onto latest `origin/dev`
...
- `c7ace7cead` — `fix(ai): promote recoverable memory repair rows (#14062)`
