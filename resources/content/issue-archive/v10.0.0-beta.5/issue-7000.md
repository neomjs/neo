...
- 2025-07-09 @tobiu referenced in commit `4d2aecc` - "grid.Container: afterSetColumns() => fine-tune the condition, when header.Toolbar items need to get processed #7000"
