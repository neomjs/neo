...
This "SDK Pattern" proves that our AI infrastructure isn't siloed "magic"—it's **composable infrastructure**. Build scripts, GitHub Actions, and developer tools can import and execute the same business logic services that power the Neural Link.
...
All changes delivered in 1 atomic commit: https://github.com/neomjs/neo/commit/[COMMIT_HASH]
