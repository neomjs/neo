...
const agent = Neo.create(Agent, {
    ...
    modelProvider: {className: 'Neo.ai.provider.Gemini'}
});
...
## 🔮 What's Next: Phase 4 - The Neural Link

With the cognitive runtime complete, our next milestone is **bidirectional real-time communication** between agents and browser applications:

- **WebSocket RMA:** Agents will call browser methods directly.
- **LogBridge:** Workers will stream console output to agents.
- **Event Subscriptions:** Agents will react to DOM/component events.
- **Multi-Agent Orchestration:** Swarm coordination protocols.

**Target:** Q1 2026 (See `.github/AGENT_ARCHITECTURE.md`)
