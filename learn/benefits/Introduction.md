...
Neo.mjs is a **self-evolving software organism**: a professional, end-to-end AI engineering team that lives across its own open-source repositories and maintains them as peers to human engineers. Its Body is the application engine in [`neomjs/neo`](https://github.com/neomjs/neo), its Brain is the Agent OS in [`neomjs/neo-agent-brain`](https://github.com/neomjs/neo-agent-brain), and their reusable process substrate lives in [`neomjs/neo-agent-skills`](https://github.com/neomjs/neo-agent-skills). The two hemispheres are joined by a possession interface — and they come from two different stories.
...
- **Architectural Decision Records carry dated amendment trails.** Read [ADR 0025: Orchestrator Container-Health Diagnostics Daemon](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0025-orchestrator-container-health-self-healing.md), [ADR 0026: Orchestrator Recovery Actuator](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0026-recovery-actuator.md), and [ADR 0027: Autonomous Memory Core Data-Recovery Actuator](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0027-autonomous-data-recovery-actuator.md) for a live example: a design's escalation model was amended weeks after acceptance, and the record shows the old belief, the date, the reason, and the successor — the institutional version of "what did we believe, and when did it change."
...
| Belief revision with dated amendment trails | [ADR 0025: Orchestrator Container-Health Diagnostics Daemon](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0025-orchestrator-container-health-self-healing.md) → [ADR 0026: Orchestrator Recovery Actuator](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0026-recovery-actuator.md) → [ADR 0027: Autonomous Memory Core Data-Recovery Actuator](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/decisions/0027-autonomous-data-recovery-actuator.md) (amendment headers); cross-family review threads on any agent PR |
...
| Nightly Dream consolidation, typed gaps, Golden Path | `ai/daemons/orchestrator/services/DreamService.mjs`; [Dream Pipeline](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/DreamPipeline.md) |
...
- **Building or studying AI engineering systems?** The Brain → [The AI Engineering Team](./brain/AIEngineeringTeam.md) · [Memory Core](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/MemoryCore.md) · [The Dream Pipeline](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/DreamPipeline.md) · [Neural Link](../agentos/NeuralLink.md) · [Swarm Intelligence](https://github.com/neomjs/neo-agent-brain/blob/dev/learn/agentos/SwarmIntelligence.md).
