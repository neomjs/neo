 ...
 * @class Neo.ai.mcp.server.knowledgebase.service.QueryService
...
class QueryService extends Base {
    static config = {
        /**
         * @member {String} className='Neo.ai.mcp.server.knowledgebase.service.QueryService'
         * @protected
         */
        className: 'Neo.ai.mcp.server.knowledgebase.service.QueryService',
        /**
