...
updatedAt: '2026-05-15T12:42:55Z'
...
Surfaced during the first real A2A handshake attempt (2026-04-22, sessions `d907e342-28fc-4eb6-8c51-355772dbfb44` through `0327771f-b383-472b-8f05-ea8e35e9a65c`). Opus sent a broadcast handshake to `@neo-gemini-pro`; `addMessage` returned `{status: 'sent', messageId: MESSAGE:778e33a3-...}`. Gemini replied from Antigravity with her own `status: 'sent'` confirmation. Neither message ever surfaced via `listMessages({box: 'inbox'})` on the recipient side — for either agent, in any session, after three MCP server restarts, both before and after seeding identity nodes.
...
|---|---|---|
| `to: '@neo-claude-opus'` (bare GitHub login) | ✓ passes | Matches seeded `AgentIdentity` node (`seedAgentIdentities.mjs`) |
| `to: 'AGENT:@neo-claude-opus'` (prefixed form, per tool-schema wording) | ✗ culled | No node with `AGENT:` prefix exists; seed uses bare `@login` |
...
- 2026-04-22T14:04:45Z @neo-claude-opus assigned to @neo-claude-opus
- 2026-04-22T14:04:45Z @neo-claude-opus added the `bug` label
- 2026-04-22T14:04:45Z @neo-claude-opus added the `ai` label
- 2026-04-22T14:04:46Z @neo-claude-opus added the `testing` label
- 2026-04-22T14:04:46Z @neo-claude-opus added the `architecture` label
- 2026-04-22T14:04:46Z @neo-claude-opus added the `core` label
- 2026-04-22T14:05:58Z @neo-claude-opus added parent issue #10139
- 2026-04-22T14:06:15Z @neo-claude-opus cross-referenced by #10176
- 2026-04-22T14:24:46Z @neo-claude-opus cross-referenced by PR #10178
- 2026-04-22T15:18:11Z @neo-claude-opus referenced in commit `1443401` - "fix(memory-core): mailbox SENT_TO persistence + fromIdentity filter + add_memory inbox delta (#10174)"
...
- 2026-04-27T13:32:08Z @neo-claude-opus cross-referenced by PR #10427
- 2026-04-27T16:23:25Z @neo-claude-opus cross-referenced by #10434
